...
},{"../modules/fileManager.js":9,"./ui.js":3,"./validate.js":4}],3:[function(require,module,exports){
"use strict";
...
},{"../functions/calc.js":1,"../octoprint.js":15}],7:[function(require,module,exports){
"use strict";
...
},{"../functions/ui.js":3,"../octofarm.js":14,"../octoprint.js":15}],8:[function(require,module,exports){
"use strict";
...
},{"../octofarm.js":14}],9:[function(require,module,exports){
"use strict";
...
},{"../functions/calc.js":1,"../functions/dragAndDrop.js":2,"../functions/ui.js":3,"../octofarm.js":14,"../octoprint.js":15,"./clientQueue.js":5,"./fileSorting.js":10,"./printerSelect.js":12}],10:[function(require,module,exports){
"use strict";
...
},{"./fileManager.js":9}],11:[function(require,module,exports){
"use strict";
...
},{"../functions/calc.js":1,"../functions/ui.js":3,"../modules/fileSorting.js":10,"../octofarm.js":14,"../octoprint.js":15,"./customScripts.js":7,"./filamentGrab.js":8,"./fileManager.js":9}],12:[function(require,module,exports){
"use strict";
...
},{"../functions/ui.js":3,"../octofarm.js":14}],13:[function(require,module,exports){
"use strict";
...
var groupStartNames = ['rij', 'row', 'group', 'groep'];
var selectableTilePrefix = 'panel-selectable';
var massDragAndDropId = 'mass-drag-and-drop';
var massDragAndDropStatusId = 'mass-drag-and-drop-status';
var groupSplitString = '_';
var gutterHalfSize = '5px'; // Be conservative! Keep small screen in mind.

var blockCountMax = 3; // Indices 0,1,2,3 allowed

var groupsPerGallery = 4; // Square blocks of 2x2 printers, in Y direction

var galleries = 2;
var groupWidth = 2; // Used to translate gallery coordinates to real X

var groupHeight = 2;
var mapRealLimits = [galleries * groupWidth, groupsPerGallery * groupHeight];
var elems = [];
...
function parseGroupLocation(printer) {
  ...
  if (!hasGroupStartName) {
    throw new Error("Printer group does not meet convention (value: ".concat(printer.group, "). Contact DEV~ID."));
  }

  var splitPrinterGroupName = printerGroupCut.split(groupSplitString);

  if (!(splitPrinterGroupName === null || splitPrinterGroupName === void 0 ? void 0 : splitPrinterGroupName.length) > 1) {
    throw new Error("Printer group name is not according to x_x location convention. Contact DEV~ID.");
  }

  return splitPrinterGroupName.map(function (gn) {
    return parseInt(gn);
  });
}
...
function massDragAndDropPanel() {
  return "\n  <div class=\"col-12\">\n    <div class=\"card\" id=\"".concat(massDragAndDropId, "\">\n      <div class=\"card-header dashHeader\">\n        <strong>Drag a file here to mass print</strong>\n      </div>\n      <div class=\"card-body pt-1 pb-0 pl-2 pr-2\">\n        <div id=\"").concat(massDragAndDropStatusId, "\">\n          Currently 0 printers selected. No use in dropping file in this state.\n        </div>\n      </div>\n    </div>\n  </div>\n  ");
}

function drawPanelView(printer, realCoord, clientSettings, isLeftOfGutter, isRightOfGutter, markState) {
  var _printer$printerState, _printer$printerState2;

  var printerLoc = "<strong>".concat(realCoord[0], " ").concat(realCoord[1], "</strong>");
  var name = cleanPrinterName(printer);
  var gutterStyle = isLeftOfGutter ? "style=\"margin-right:".concat(gutterHalfSize, "; margin-left:-").concat(gutterHalfSize, ";\"") : isRightOfGutter ? "style=\"margin-right:-".concat(gutterHalfSize, "; margin-left:").concat(gutterHalfSize, ";\"") : "";
  var stubOrNotClass = !!printer.stub ? 'printer-map-tile-stub' : 'printer-map-tile';
  return "\n      <div class=\"col-sm-3 col-md-3 col-lg-3 col-xl-3 ".concat(stubOrNotClass, " ").concat(markState, "\" id=\"panel-").concat(printer._id, "\" ").concat(gutterStyle, ">\n        <div class=\"card mt-1 mb-1 ml-1 mr-1 text-center ").concat((_printer$printerState = printer.printerState) === null || _printer$printerState === void 0 ? void 0 : _printer$printerState.colour.category, "\" id=\"").concat(selectableTilePrefix, "-").concat(printer._id, "\">\n          <div class=\"card-header dashHeader\">\n           <span id=\"name-").concat(printer._id, "\" class=\"mb-0 btn-sm float-left\">\n                ").concat(name, "\n            </span>\n            <span id=\"coord-X").concat(realCoord[0], "-Y{").concat(realCoord[1], "\" class=\"mb-0 btn-sm float-right\">\n              ").concat(printerLoc, "\n            </span>\n          </div>\n          <div class=\"card-body pt-1 pb-0 pl-2 pr-2\">\n            <div class=\"progress\">\n              <div\n                id=\"progress-").concat(printer._id, "\"\n                class=\"progress-bar progress-bar-striped bg-").concat((_printer$printerState2 = printer.printerState) === null || _printer$printerState2 === void 0 ? void 0 : _printer$printerState2.colour.name, " percent\"\n                role=\"progressbar progress-bar-striped\"\n                style=\"width: 0%\"\n                aria-valuenow=\"0\"\n                aria-valuemin=\"0\"\n                aria-valuemax=\"100\">\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    ");
}

function addListeners(printer, allPrinters) {
  printer.isSelected = false;
  var panel = document.getElementById("".concat(selectableTilePrefix, "-").concat(printer._id));

  if (panel) {
    panel.addEventListener("click", function (e) {
      var tokenPresent = panel.classList.toggle('printer-map-tile-selected');
      printer.isSelected = tokenPresent;
      var massDragAndDropStatusPanel = document.getElementById(massDragAndDropStatusId);

      if (massDragAndDropStatusPanel) {
        var _allPrinters$filter;

        var selectedPrinterCount = (_allPrinters$filter = allPrinters.filter(function (p) {
          return !!p.isSelected;
        })) === null || _allPrinters$filter === void 0 ? void 0 : _allPrinters$filter.length;

        if (selectedPrinterCount === 0) {
          massDragAndDropStatusPanel.innerHTML = "Currently ".concat(selectedPrinterCount, " printers selected. No use in dropping file in this state.");
        } else {
          massDragAndDropStatusPanel.innerHTML = "Currently ".concat(selectedPrinterCount, " printers selected. Time to print!");
        }
      } else {
    ...
    throw new Error("Could not find the printer panel to add listeners to, id: ".concat(selectableTilePrefix, "-").concat(printer._id));
  }
...
function _updateState() {
  _updateState = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(printer, clientSettings, view) {
    var elements, stateCategory, progress, printTimeElapsedFormat, remainingPrintTimeFormat;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
          ...
          case 3:
            ...
            _context2.t0 = view;
            _context2.next = _context2.t0 === "list" ? 8 : _context2.t0 === "panel" ? 10 : 12;
            break;
          ...
          case 16:
            ...
            _ui["default"].doesElementNeedUpdating(cleanPrinterName(printer), elements.name, "innerHTML");

            _context2.t1 = view;
            _context2.next = _context2.t1 === "list" ? 22 : _context2.t1 === "panel" ? 24 : 26;
            break;
          ...
          case 26:
            ...
            if (typeof printer.currentJob !== "undefined") {
              ...
              remainingPrintTimeFormat = ""; //No Job reset

              _ui["default"].doesElementNeedUpdating("", elements.progress, "innerHTML");
...
function findPrinterWithBlockCoordinate(parsedPrinters, coordinateXY) {
  ...
  return parsedPrinters.find(function (pm) {
    return (pm === null || pm === void 0 ? void 0 : pm.realCoord[0]) === coordinateXY[0] && (pm === null || pm === void 0 ? void 0 : pm.realCoord[1]) === coordinateXY[1];
  });
}
...
function convertPrinterNameToXYCoordinate(printer) {
  ...
  var printerName = printer.printerName;
  var splitNamePort = printerName.split(':');

  if (!(splitNamePort === null || splitNamePort === void 0 ? void 0 : splitNamePort.length) > 1) {
    return [-1, -1];
  }

  var parsedPort = parseInt(splitNamePort[2]) % 10;
...
function _init() {
  _init = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(printers, clientSettings, view) {
    var massDragAndDropPanelDom, panelHtml, parsedPrinters, realY, realX, printerWithCoord, printer, printerPanel, printerHTML;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.t0 = printerManagerModal.classList.contains("show");
            _context3.next = _context3.t0 === true ? 3 : _context3.t0 === false ? 5 : 48;
            break;
          ...
          case 5:
            ...
            panelHtml = massDragAndDropPanel();
            printerArea.insertAdjacentHTML("beforeend", panelHtml); // Attach drag and drop to mass upload

            massDragAndDropPanelDom = document.getElementById(massDragAndDropId);
            _context3.next = 12;
            return (0, _dragAndDrop.dragAndDropEnableMultiplePrinters)(massDragAndDropPanelDom, printers);

          case 12:
            // initialise or start the information updating..
            parsedPrinters = _toConsumableArray(printers.map(function (p) {
              var parsedGroupCoord = parseGroupLocation(p);
              var printerSubCoordinate = convertPrinterNameToXYCoordinate(p);
              return {
                printer: p,
          ...
          case 16:
            if (!(realX < mapRealLimits[0])) {
              _context3.next = 44;
              break;
            }

            printerWithCoord = findPrinterWithBlockCoordinate(parsedPrinters, [realX, realY]);
            printer = null;

            if (!printerWithCoord) {
              // We construct a fakey
              printer = {
                _id: "X".concat(realX, "Y").concat(realY, "STUB"),
                stub: true,
                printerName: '',
                printerState: {
                  colour: {
            ...
            _context3.next = 24;
            return drawPanelView(printer, [realX, realY], clientSettings, realX === groupWidth - 1, // Left of gutter (f.e. X=1 of 0,1,2,3)
            realX === groupWidth // Right of gutter ((f.e. X=2 of 0,1,2,3)
            );

          case 24:
            printerHTML = _context3.sent;
            printerArea.insertAdjacentHTML("beforeend", printerHTML); //Update the printer panel to the actual one

            printerPanel = document.getElementById("panel-" + printer._id); //Add page listeners
            ...
            _context3.next = 30;
            return grabElements(printer);

          case 30:
            _context3.next = 32;
            return (0, _dragAndDrop.dragAndDropEnable)(printerPanel, printer);
          ...
          case 37:
            ...
            _context3.next = 40;
            return updateState(printer, clientSettings, view);
...
},{"../functions/dragAndDrop.js":2,"../functions/ui.js":3,"../octofarm":14,"./currentOperations":6,"./printerManager.js":11}],14:[function(require,module,exports){
"use strict";
...
},{"./functions/ui.js":3,"./functions/validate.js":4,"./modules/filamentGrab.js":8,"./octofarm.js":14}],16:[function(require,module,exports){
"use strict";

var _viewUpdaterPrinterMap = _interopRequireDefault(require("./lib/modules/viewUpdaterPrinterMap.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }

(0, _viewUpdaterPrinterMap["default"])("panel");

},{"./lib/modules/viewUpdaterPrinterMap.js":13}]},{},[16]);
