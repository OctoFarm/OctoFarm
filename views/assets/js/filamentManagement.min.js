...
function addProfile(_x, _x2, _x3, _x4) {
  return _addProfile.apply(this, arguments);
}

function _addProfile() {
  _addProfile = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(manufacturer, material, density, diameter) {
    var errors, opts, post, profileID;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            if (material.value === "") {
              errors.push({
                type: "warning",
                msg: "Please select or type a material"
              });
            }
            ...
            errors.forEach(function (error) {
              _ui["default"].createMessage(error, "profilesMessage");
            });
          ...
          case 8:
            ...
            _context.next = 11;
            return _octofarm["default"].post("filament/save/profile", opts);
          ...
          case 16:
            ...
            updateProfileDrop();
            document.getElementById("addProfilesTable").insertAdjacentHTML("beforeend", "\n                <tr data-jplist-item>\n                  <th style=\"display: none;\">".concat(profileID, "</th>\n                  <th scope=\"row\"><input class=\"form-control\" type=\"text\" placeholder=\"").concat(post.profile.manufacturer, "\"></th>\n                  <td><input class=\"form-control\" type=\"text\" placeholder=\"").concat(post.profile.material, "\"></td>\n                  <td><input class=\"form-control\" type=\"text\" placeholder=\"").concat(post.profile.density, "\"></p></td>\n                  <td><input class=\"form-control\" type=\"text\" placeholder=\"").concat(post.profile.diameter, "\"></p></td>\n                  <td><button id=\"edit-").concat(profileID, "\" type=\"button\" class=\"btn btn-sm btn-info edit\">\n                    <i class=\"fas fa-edit editIcon\"></i>\n                  </button>\n                  <button id=\"save-").concat(profileID, "\" type=\"button\" class=\"btn btn-sm d-none btn-success save\">\n                    <i class=\"fas fa-save saveIcon\"></i>\n                  </button>\n                  <button id=\"delete-").concat(profileID, "\" type=\"button\" class=\"btn btn-sm btn-danger delete\">\n                    <i class=\"fas fa-trash deleteIcon\"></i>\n                  </button></td>\n                </tr>\n                "));
            _context.next = 30;
            break;
...
function editProfile(_x5) {
  return _editProfile.apply(this, arguments);
}

function _editProfile() {
  _editProfile = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
    var row, editable, id;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            editable = row.querySelectorAll("input");
            ...
            document.getElementById("save-".concat(id)).classList.remove("d-none");
            document.getElementById("edit-".concat(id)).classList.add("d-none");
...
function _saveProfile() {
  _saveProfile = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
    var row, editable, id, profile, data, post;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 8;
            return _octofarm["default"].post("filament/edit/profile", data);
          ...
          case 12:
            post = _context3.sent;
            updateProfileDrop();
            document.getElementById("save-".concat(id)).classList.add("d-none");
            document.getElementById("edit-".concat(id)).classList.remove("d-none");
...
function deleteProfile(_x7) {
  return _deleteProfile.apply(this, arguments);
} // Spool functions


function _deleteProfile() {
  _deleteProfile = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(e) {
    var post;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 4;
            return _octofarm["default"].post("filament/delete/profile", {
              id: e.parentElement.parentElement.firstElementChild.innerHTML.trim()
            });
...
function addSpool(_x8, _x9, _x10, _x11, _x12, _x13) {
  return _addSpool.apply(this, arguments);
}

function _addSpool() {
  _addSpool = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(spoolsName, spoolsProfile, spoolsPrice, spoolsWeight, spoolsUsed, spoolsTempOffset) {
    var errors, opts, post, displayNone;
        ...
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            if (spoolsPrice.value === "") {
              errors.push({
                type: "warning",
                msg: "Please input a spool price"
              });
            }
            ...
            if (spoolsWeight.value === 0 || spoolsWeight.value === "") {
              errors.push({
                type: "warning",
                msg: "Please input a spool weight"
              });
            }
            ...
            if (spoolsUsed.value === "") {
              errors.push({
                type: "warning",
                msg: "Please input spool used weight"
              });
            }
            ...
            errors.forEach(function (error) {
              _ui["default"].createMessage(error, "addSpoolsMessage");
            });
          ...
          case 9:
            ...
            _context5.next = 12;
            return _octofarm["default"].post("filament/save/filament", opts);
          ...
          case 17:
            ...
            document.getElementById("addSpoolsTable").insertAdjacentHTML("afterbegin", "\n                <tr data-jplist-item>\n                  <th style=\"display: none;\">".concat(post._id, "</th>\n                  <th scope=\"row\"><input class=\"form-control\" type=\"text\" placeholder=\"").concat(post.spools.name, "\"></th>\n                  <td>\n                       <select id=\"spoolsProfile-").concat(post._id, "\" class=\"form-control\" disabled>\n\n                       </select>\n                   </td>\n                  <td><input class=\"form-control\" type=\"text\" placeholder=\"").concat(post.spools.price, "\"></td>\n                  <td><input class=\"form-control\" type=\"text\" placeholder=\"").concat(post.spools.weight, "\"></td>\n                  <td class=\"").concat(displayNone, "\"><input class=\"form-control\" type=\"text\" placeholder=\"").concat(post.spools.used, "\"></td>\n                  <td class=\"grams ").concat(displayNone, "\">").concat((post.spools.weight - post.spools.used).toFixed(0), "</td>\n                  <td class=\"percent ").concat(displayNone, "\">").concat((100 - post.spools.used / post.spools.weight * 100).toFixed(0), "</td>\n                  <td><input class=\"form-control\" type=\"text\" placeholder=\"").concat(post.spools.tempOffset, "\"></td>\n                   <td>\n                       <select id=\"spoolsPrinterAssignment-").concat(post._id, "\" class=\"form-control\">\n\n                       </select>\n                   </td>\n                  <td><button id=\"edit-").concat(post._id, "\" type=\"button\" class=\"btn btn-sm btn-info edit\">\n                    <i class=\"fas fa-edit editIcon\"></i>\n                  </button>\n                  <button id=\"save-").concat(post._id, "\" type=\"button\" class=\"btn btn-sm d-none btn-success save\">\n                    <i class=\"fas fa-save saveIcon\"></i>\n                  </button>\n                  <button id=\"delete-").concat(post._id, "\" type=\"button\" class=\"btn btn-sm btn-danger delete\">\n                    <i class=\"fas fa-trash deleteIcon\"></i>\n                  </button></td>\n                </tr>\n                "));
            updatePrinterDrops();
            updateProfileDrop();
            _context5.next = 33;
            break;
...
function editSpool(_x14) {
  return _editSpool.apply(this, arguments);
}

function _editSpool() {
  _editSpool = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(e) {
    var row, editable, id;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            document.getElementById("spoolsProfile-".concat(id)).disabled = false;
            document.getElementById("save-".concat(id)).classList.remove("d-none");
            document.getElementById("edit-".concat(id)).classList.add("d-none");
...
function deleteSpool(_x15) {
  return _deleteSpool.apply(this, arguments);
}

function _deleteSpool() {
  _deleteSpool = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(e) {
    var post;
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            _context7.next = 4;
            return _octofarm["default"].post("filament/delete/filament", {
              id: e.parentElement.parentElement.firstElementChild.innerHTML.trim()
            });
...
function saveSpool(_x16) {
  return _saveSpool.apply(this, arguments);
}

function _saveSpool() {
  _saveSpool = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(e) {
    var row, editable, id, spool, data, post;
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            spool.push(document.getElementById("spoolsProfile-".concat(id)).value);
            data = {
              id: id,
              spool: spool
            };
            _context8.next = 9;
            return _octofarm["default"].post("filament/edit/filament", data);
          ...
          case 13:
            post = _context8.sent;
            document.getElementById("spoolsProfile-".concat(id)).disabled = true;
            document.getElementById("save-".concat(id)).classList.add("d-none");
            document.getElementById("edit-".concat(id)).classList.remove("d-none");
...
function updateProfileDrop() {
  return _updateProfileDrop.apply(this, arguments);
}

function _updateProfileDrop() {
  _updateProfileDrop = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9() {
    var spoolsProfile, profiles, fill, profile, printerDrops, printerListMaterials, spoolsListManufacture, spoolsMaterialText;
    return regeneratorRuntime.wrap(function _callee9$(_context9) {
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            // Update filament selection profile drop
            spoolsProfile = document.getElementById("spoolsProfile");
            _context9.next = 3;
            return _octofarm["default"].get("filament/get/profile");
          ...
          case 6:
            profiles = _context9.sent;
            _context9.next = 9;
            return _octofarm["default"].get("filament/get/filament");
          ...
          case 18:
            ...
            if (typeof profiles !== "undefined") {
              ...
              profiles.profiles.forEach(function (profile) {
                ...
                spoolsProfile.insertAdjacentHTML("beforeend", "\n             <option value=\"".concat(profileID, "\">").concat(profile.manufacturer, " (").concat(profile.material, ")</option>\n            "));
              });
            } // Generate profile assignment


            printerDrops = document.querySelectorAll("[id^='spoolsProfile-']");
            printerListMaterials = document.querySelectorAll("[id^='spoolsListMaterial-']");
            spoolsListManufacture = document.querySelectorAll("[id^='spoolsListManufacture-']");
            spoolsMaterialText = document.querySelectorAll("[id^='spoolsMaterialText-']");
            printerDrops.forEach(function (drop, index) {
              drop.innerHTML = "";
              profiles.profiles.forEach(function (prof) {
                drop.insertAdjacentHTML("beforeend", "<option value=\"".concat(prof._id, "\">").concat(prof.manufacturer, " (").concat(prof.material, ")</option>"));
              });
              var spoolID = drop.id.split("-"); // eslint-disable-next-line no-undef

              var spool = _.findIndex(fill.Spool, function (o) {
              ...
              if (typeof fill.Spool[spool] !== "undefined") {
                ...
                var profileID = _.findIndex(profiles.profiles, function (o) {
                  return o._id == fill.Spool[spool].profile;
                });

                drop.className = "form-control ".concat(profiles.profiles[profileID].material.replace(/ /g, "_"));
                printerListMaterials[index].innerHTML = "".concat(profiles.profiles[profileID].material);
                spoolsMaterialText[index].innerHTML = "".concat(profiles.profiles[profileID].material);
                spoolsListManufacture[index].innerHTML = "".concat(profiles.profiles[profileID].manufacturer);
              }
            });
...
function updatePrinterDrops() {
  return _updatePrinterDrops.apply(this, arguments);
}

function _updatePrinterDrops() {
  _updatePrinterDrops = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10() {
    var printerList, filament, printerDrops, printerAssignments;
    return regeneratorRuntime.wrap(function _callee10$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            _context10.next = 2;
            return _octofarm["default"].get("filament/get/printerList");

          case 2:
            printerList = _context10.sent;
            _context10.next = 5;
            return printerList.json();
          ...
          case 8:
            filament = _context10.sent;
            _context10.next = 11;
            return filament.json();

          case 11:
            filament = _context10.sent;
            printerDrops = document.querySelectorAll("[id^='spoolsPrinterAssignment-']");
            printerAssignments = document.querySelectorAll("[id^='spoolsListPrinterAssignment-']");
            printerDrops.forEach(function (drop, index) {
              drop.innerHTML = _toConsumableArray(printerList.printerList);
              var split = drop.id.split("-");
              var spoolID = split[1];

              var spool = _.findIndex(filament.Spool, function (o) {
                return o._id == spoolID;
              });

              if (typeof filament.Spool[spool] !== "undefined") {
                if (filament.Spool[spool].printerAssignment.length > 0) {
                  drop.value = filament.Spool[spool].printerAssignment[0].id + "-" + filament.Spool[spool].printerAssignment[0].tool;
                  printerAssignments[index].innerHTML = filament.Spool[spool].printerAssignment[0].name + ": Tool" + filament.Spool[spool].printerAssignment[0].tool;
                } else {
              ...
              drop.addEventListener("change", function (e) {
                var meta = e.target.value.split("-");
                var printerId = meta[0];
                var tool = meta[1];
                var spoolId = e.target.id.split("-");
                (0, _filamentGrab.selectFilament)(printerId, spoolId[1], tool);
              });
            });
...
function _init() {
  _init = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14() {
    var today, lastThirtyDays, i, day, previousDay, lastThirtyDaysText, historyStatistics, usageByDay, usageOverTime, yAxisSeries, usageOverTimeOptions, systemFarmTemp, usageOverFilamentTimeOptions, usageOverFilamentTime, spoolTable, dataList, profilesBtn, resyncBtn;
    return regeneratorRuntime.wrap(function _callee14$(_context14) {
      while (1) {
        switch (_context14.prev = _context14.next) {
          ...
          case 19:
            historyStatistics = _context14.sent;
            _context14.next = 22;
          ...
          case 22:
            ...
            if (typeof usageOverTime[0] !== "undefined") {
              ...
              systemFarmTemp = new ApexCharts(document.querySelector("#usageOverTime"), usageOverTimeOptions);
            ...
            spoolTable = document.getElementById("addSpoolsTable"); // Initialise materials dropdown

            dataList = document.getElementById("profilesMaterial");
            dataList.addEventListener("change", function (e) {
              var value = this.value;

              var selection = _.findIndex(filamentStore, function (o) {
            ...
            filamentStore.forEach(function (filament) {
              document.getElementById("huge_list").insertAdjacentHTML("beforeend", "\n            <option value=\"".concat(filament.code.toUpperCase(), "\">").concat(filament.display, "</option>\n        "));
            });
            spoolTable.addEventListener("click", function (e) {
              // Remove from UI
              if (e.target.classList.contains("edit")) {
                editSpool(e.target);
              } else if (e.target.classList.contains("delete")) {
            ...
            updateProfileDrop();
            updatePrinterDrops(); // Initialise Profile Listeners

            profilesBtn = document.getElementById("addProfilesBtn");
            profilesBtn.addEventListener("click", /*#__PURE__*/function () {
              var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(e) {
                var profilesManufactuer, profilesMaterial, profilesDensity, profilesDiameter;
                  ...
                  while (1) {
                    switch (_context11.prev = _context11.next) {
                      case 0:
                        ...
                        e.stopPropagation();
                        document.getElementById("profilesMessage").innerHTML = "";
                        profilesManufactuer = document.getElementById("profilesManufactuer");
                        profilesMaterial = document.getElementById("profilesMaterial");
                        profilesDensity = document.getElementById("profilesDensity");
                        profilesDiameter = document.getElementById("profilesDiameter");
                        _context11.next = 9;
                        return addProfile(profilesManufactuer, profilesMaterial, profilesDensity, profilesDiameter);
            ...
            document.getElementById("addProfilesTable").addEventListener("click", function (e) {
              // Remove from UI
              if (e.target.classList.contains("edit")) {
                editProfile(e.target);
              } else if (e.target.classList.contains("delete")) {
            ...
            document.getElementById("addSpoolBtn").addEventListener("click", /*#__PURE__*/function () {
              var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(e) {
                var spoolsName, spoolsProfile, spoolsPrice, spoolsWeight, spoolsUsed, spoolsTempOffset;
                  ...
                  while (1) {
                    switch (_context12.prev = _context12.next) {
                      case 0:
                        ...
                        spoolsName = document.getElementById("spoolsName");
                        spoolsProfile = document.getElementById("spoolsProfile");
                        spoolsPrice = document.getElementById("spoolsPrice");
                        spoolsWeight = document.getElementById("spoolsWeight");
                        spoolsUsed = document.getElementById("spoolsRemaining");
                        spoolsTempOffset = document.getElementById("spoolsTempOffset");
          ...
          case 41:
            filamentManager = _context14.sent;

            if (filamentManager) {
              resyncBtn = document.getElementById("resyncFilament");
              resyncBtn.addEventListener("click", /*#__PURE__*/function () {
                var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13(e) {
                  var post, meta;
                    ...
                    while (1) {
                      switch (_context13.prev = _context13.next) {
                        ...
                        case 8:
                          ...
                          if (meta.success) {
                            _ui["default"].createAlert("success", "Successfully synced filament manager! <br> Profiles - Updated: ".concat(meta.updatedProfiles, " / New: ").concat(meta.newProfiles, " <br> Spools - Updated: ").concat(meta.updatedSpools, " / New: ").concat(meta.newSpools), 4000, "Clicked");
                          } else {
                            _ui["default"].createAlert("error", "Successfully synced filament manager! <br> Profiles Status: ".concat(meta.profiles, " <br> Spools Status: ").concat(meta.spools), 4000, "Clicked");
                          }
                        ...
                        case 14:
                          _ui["default"].createAlert("error", "Could not contact server to sync, is it online?");
...
function updateTotals(filtered) {
  ...
  var usedReduced = used.reduce(function (a, b) {
    return a + b;
  }, 0).toFixed(0);
  var weightReduced = weight.reduce(function (a, b) {
    return a + b;
  }, 0).toFixed(0);
  document.getElementById("totalPrice").innerHTML = price.reduce(function (a, b) {
    return a + b;
  }, 0).toFixed(0);
...
var element = document.getElementById("listenerSpools");
...
},{"../octofarm.js":4}],4:[function(require,module,exports){
"use strict";
