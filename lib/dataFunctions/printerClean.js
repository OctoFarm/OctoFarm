        ...
        RoomData.find({}).sort('-date')
            .limit(1500).exec(function(err, posts){
                ...
                for(let i = 0; i < enviromentalData.length; i++){
                    ...
                    if(enviromentalData[i].gas_resistance !== null){
                        const iaq = new IAQ(enviromentalData[i].gas_resistance, enviromentalData[i].humidity, 25, 5000, 50000000);
                        ...
                        //
                        // currentIAQ.push(values.iaqScore);
                        // if(currentIAQ.length >= 2){
                        //     currentIAQ.shift();
                        // }
