    ...
    static async statisticsStart () {
      ...
      history.currentFailed + activeHours + idleHours + offlineHours;
        ...
        RoomData.find({}).sort('-date')
            .limit(500).exec(function(err, posts){
                ...
                for(let i = 0; i < enviromentalData.length; i++){
                    if(typeof enviromentalData[i].temperature !== 'undefined' && enviromentalData[i].temperature !== null){
                    ...
                    if(typeof enviromentalData[i].humidity !== 'undefined' && enviromentalData[i].humidity !== null){
                    ...
                    if(typeof enviromentalData[i].pressure !== 'undefined' && enviromentalData[i].pressure !== null){
