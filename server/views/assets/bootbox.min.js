...
!(function (t, e) {
  ...
  function c(t, e, o) {
    return p.extend(
      ...
      (function (t, e) {
        ...
        return (
          2 === o || "string" == typeof t[0] ? ((a[e[0]] = t[0]), (a[e[1]] = t[1])) : (a = t[0]), a
        );
      })(e, o)
    );
  }
  function h(t, e, o, a) {
    ...
    return (
      ...
      g(n.buttons, function (t) {
        if (l[t] === u)
          throw new Error(
            'button key "' + t + '" is not allowed (options are ' + i.join(" ") + ")"
          );
      }),
      n
    );
  ...
  return (
      ...
      if (
        ((t = (function (r) {
          ...
          (r = p.extend({}, m, r)).backdrop
            ? (r.backdrop =
                "string" != typeof r.backdrop || "static" !== r.backdrop.toLowerCase() || "static")
          ...
          return (
            ...
            (i = w(n)),
            g(n, function (t, e, o) {
              if ((p.isFunction(e) && (e = n[t] = { callback: e }), "object" !== p.type(e)))
    ...
    (d.confirm = function () {
      var t;
      if (
        ((t = h("confirm", ["cancel", "confirm"], ["message", "callback"], arguments)),
        !p.isFunction(t.callback))
      )
    ...
    (d.prompt = function () {
      ...
      if (
        ((t = p(f.form)),
        (r = h("prompt", ["cancel", "confirm"], ["title", "callback"], arguments)).value ||
          (r.value = m.value),
      ...
      switch (((n = p(f.inputs[r.inputType])), r.inputType)) {
        ...
        case "range":
          ...
          !(function (t, e, o) {
            ...
            (r.min !== u && n.attr("min", r.min), r.max !== u && n.attr("max", r.max));
          break;
        case "select":
          var i = {};
          ...
          r.placeholder && n.attr("placeholder", r.placeholder),
            ...
            g(a, function (t, e) {
              ...
              e.group &&
                (i[e.group] || (i[e.group] = p("<optgroup />").attr("label", e.group)),
                (o = i[e.group]));
              var a = p(f.option);
