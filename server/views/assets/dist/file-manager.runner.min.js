...
"use strict";
/*!***********************************!*\
  !*** ./js/file-manager.runner.js ***!
  \***********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./services/octofarm-client.service */ "./js/services/octofarm-client.service.js");
/* harmony import */ var _utils_calc_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/calc.js */ "./js/utils/calc.js");
/* harmony import */ var _services_file_manager_service_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./services/file-manager.service.js */ "./js/services/file-manager.service.js");
/* harmony import */ var _utils_dragAndDrop_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils/dragAndDrop.js */ "./js/utils/dragAndDrop.js");
/* harmony import */ var _services_filament_manager_plugin_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./services/filament-manager-plugin.service */ "./js/services/filament-manager-plugin.service.js");
/* harmony import */ var _services_file_manager_sorting_service_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./services/file-manager-sorting.service.js */ "./js/services/file-manager-sorting.service.js");
/* harmony import */ var _constants_file_types_constants__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./constants/file-types.constants */ "./js/constants/file-types.constants.js");
...
if (multiUploadBtn) {
  multiUploadBtn.addEventListener("click", (e) => {
    _services_file_manager_service_js__WEBPACK_IMPORTED_MODULE_2__.default.multiUpload();
  });
}

class Manager {
  static async drawPrinterList() {
    let printers = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_0__.default.listPrinters();
    ...
    onlinePrinterList.forEach((printer, index) => {
      ...
      (0,_utils_dragAndDrop_js__WEBPACK_IMPORTED_MODULE_3__.dragAndDropEnable)(listItem, printer);

      for (let i = 0; i < printer.currentProfile.extruder.count; i++) {
        const filamentDrop = document.getElementById("tool" + i + "-" + printer._id);
        (0,_services_filament_manager_plugin_service__WEBPACK_IMPORTED_MODULE_4__.createFilamentSelector)(filamentDrop, printer, i);
      }
  ...
  static async updatePrinterList(id) {
    ...
    fileList.innerHTML = `
         <div class="row mb-1">
          <div class="col-12">
            ...
            <input id="fileUploadBtn" multiple accept="${_constants_file_types_constants__WEBPACK_IMPORTED_MODULE_6__.allowedFileTypes}" type="file" class="btn btn-success float-left bg-colour-1">
            ...
            <input id="fileUploadPrintBtn" accept="${_constants_file_types_constants__WEBPACK_IMPORTED_MODULE_6__.allowedFileTypes}" type="file" class="btn btn-success float-left bg-colour-2">
            <button
                    id="createFolderBtn"
                    type="button"
    ...
    let printer = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_0__.default.getPrinter(id);

    await _services_file_manager_sorting_service_js__WEBPACK_IMPORTED_MODULE_5__.default.loadSort(printer._id);
    ...
    if (typeof printer.storage !== "undefined") {
      fileButtons.fileManager.printerStorage.innerHTML = `<i class="fas fa-hdd"></i> ${_utils_calc_js__WEBPACK_IMPORTED_MODULE_1__.default.bytes(
    ...
    fileButtons.fileManager.uploadFiles.addEventListener("change", function () {
      _services_file_manager_service_js__WEBPACK_IMPORTED_MODULE_2__.default.handleFiles(this.files, printer);
    });
    fileButtons.fileManager.createFolderBtn.addEventListener("click", (e) => {
      _services_file_manager_service_js__WEBPACK_IMPORTED_MODULE_2__.default.createFolder(printer);
    });
    fileButtons.fileManager.fileSearch.addEventListener("keyup", (e) => {
      _services_file_manager_service_js__WEBPACK_IMPORTED_MODULE_2__.default.search(printer._id);
    });
    fileButtons.fileManager.uploadPrintFile.addEventListener("change", async function () {
      await _services_file_manager_service_js__WEBPACK_IMPORTED_MODULE_2__.default.handleFiles(this.files, printer, "print");
    });
    ...
    fileButtons.fileManager.back.addEventListener("click", async (e) => {
      await _services_file_manager_service_js__WEBPACK_IMPORTED_MODULE_2__.default.openFolder(undefined, undefined, printer);
    });
    fileButtons.fileManager.syncFiles.addEventListener("click", async (e) => {
      await _services_file_manager_service_js__WEBPACK_IMPORTED_MODULE_2__.default.reSyncFiles(e, printer);
    });
  }
}
