...
"use strict";
/*!**********************************************!*\
  !*** ./js/current-operations-view.runner.js ***!
  \**********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
...
/* harmony import */ var _services_octoprint_client_service_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./services/octoprint-client.service.js */ "./js/services/octoprint-client.service.js");
/* harmony import */ var _services_client_worker_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./services/client-worker.service */ "./js/services/client-worker.service.js");
/* harmony import */ var _pages_monitoring_monitoring_view_state__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./pages/monitoring/monitoring-view.state */ "./js/pages/monitoring/monitoring-view.state.js");
...
(0,_pages_monitoring_monitoring_view_state__WEBPACK_IMPORTED_MODULE_3__.setViewType)("current-ops");
(0,_services_client_worker_service__WEBPACK_IMPORTED_MODULE_2__.createClientSSEWorker)(monitoringWorkerURL, async function (data) {
  if (!!data) {
...
const resetFile = function (id) {
  ...
  _services_octoprint_client_service_js__WEBPACK_IMPORTED_MODULE_1__.default.file(printers[i], printers[i].currentJob.filePath, "load");
};
const rePrint = function (id) {
  const i = _.findIndex(printers, function (o) {
    return o._id == id;
  });
  _services_octoprint_client_service_js__WEBPACK_IMPORTED_MODULE_1__.default.file(printers[i], printers[i].currentJob.filePath, "print");
};
