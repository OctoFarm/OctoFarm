...
/***/ "./js/pages/printer-manager/functions/bulk-commands-functions.js":
/*!***********************************************************************!*\
  !*** ./js/pages/printer-manager/functions/bulk-commands-functions.js ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "bulkOctoPrintPluginUpdate": () => (/* binding */ bulkOctoPrintPluginUpdate),
/* harmony export */   "bulkOctoPrintClientUpdate": () => (/* binding */ bulkOctoPrintClientUpdate),
/* harmony export */   "bulkConnectPrinters": () => (/* binding */ bulkConnectPrinters),
/* harmony export */   "bulkDisablePrinters": () => (/* binding */ bulkDisablePrinters),
/* harmony export */   "bulkEnablePrinters": () => (/* binding */ bulkEnablePrinters),
/* harmony export */   "bulkPrintFileSetup": () => (/* binding */ bulkPrintFileSetup),
/* harmony export */   "bulkDisconnectPrinters": () => (/* binding */ bulkDisconnectPrinters),
/* harmony export */   "bulkOctoPrintPowerCommand": () => (/* binding */ bulkOctoPrintPowerCommand),
/* harmony export */   "bulkOctoPrintPreHeatCommand": () => (/* binding */ bulkOctoPrintPreHeatCommand),
/* harmony export */   "bulkOctoPrintControlCommand": () => (/* binding */ bulkOctoPrintControlCommand),
/* harmony export */   "bulkOctoPrintGcodeCommand": () => (/* binding */ bulkOctoPrintGcodeCommand),
/* harmony export */   "bulkOctoPrintPluginAction": () => (/* binding */ bulkOctoPrintPluginAction),
/* harmony export */   "bulkEnableVirtualPrinter": () => (/* binding */ bulkEnableVirtualPrinter),
/* harmony export */   "bulkUpdateOctoPrintSettings": () => (/* binding */ bulkUpdateOctoPrintSettings)
/* harmony export */ });
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _services_octofarm_client_service_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../services/octofarm-client.service.js */ "./js/services/octofarm-client.service.js");
/* harmony import */ var _utils_ui__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../utils/ui */ "./js/utils/ui.js");
/* harmony import */ var _services_printer_selection_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../services/printer-selection.service */ "./js/services/printer-selection.service.js");
/* harmony import */ var _services_octoprint_octoprint_plugin_commands__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../services/octoprint/octoprint-plugin-commands */ "./js/services/octoprint/octoprint-plugin-commands.js");
/* harmony import */ var _services_octoprint_octoprint_client_commands__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../services/octoprint/octoprint-client-commands */ "./js/services/octoprint/octoprint-client-commands.js");
/* harmony import */ var _services_octoprint_octoprint_printer_commands__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../services/octoprint/octoprint-printer-commands */ "./js/services/octoprint/octoprint-printer-commands.js");
/* harmony import */ var _services_octoprint_octoprint_settings_actions__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../services/octoprint/octoprint-settings.actions */ "./js/services/octoprint/octoprint-settings.actions.js");
/* harmony import */ var _services_custom_gcode_scripts_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../services/custom-gcode-scripts.service */ "./js/services/custom-gcode-scripts.service.js");
/* harmony import */ var _plugin_search_function__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./plugin-search.function */ "./js/pages/printer-manager/functions/plugin-search.function.js");
/* harmony import */ var _templates_octoprint_plugin_list_template__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../templates/octoprint-plugin-list.template */ "./js/pages/printer-manager/templates/octoprint-plugin-list.template.js");
/* harmony import */ var _bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./bulk-actions-progress.functions */ "./js/pages/printer-manager/functions/bulk-actions-progress.functions.js");
/* harmony import */ var _bulk_settings_update_functions__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./bulk-settings-update.functions */ "./js/pages/printer-manager/functions/bulk-settings-update.functions.js");
/* harmony import */ var _bulk_actions_constants__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../bulk-actions.constants */ "./js/pages/printer-manager/bulk-actions.constants.js");
/* harmony import */ var _constants_file_types_constants__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../../constants/file-types.constants */ "./js/constants/file-types.constants.js");
/* harmony import */ var _services_file_manager_queue_service_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../services/file-manager-queue.service.js */ "./js/services/file-manager-queue.service.js");
/* harmony import */ var _services_octoprint_client_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../../services/octoprint-client.service */ "./js/services/octoprint-client.service.js");
...
const fileUploads = new _services_file_manager_queue_service_js__WEBPACK_IMPORTED_MODULE_15__.default();
...
async function getCurrentlySelectedPrinterList(disabled) {
  try {
    const currentPrinterList = await _services_octofarm_client_service_js__WEBPACK_IMPORTED_MODULE_1__.default.listPrinters(disabled);
    const matchedPrinters = [];
    //Grab all check boxes
    const selectedPrinters = _services_printer_selection_service__WEBPACK_IMPORTED_MODULE_3__.default.getSelected();
    selectedPrinters.forEach((element) => {
      const printerID = element.id.split("-");
      const index = (0,lodash__WEBPACK_IMPORTED_MODULE_0__.findIndex)(currentPrinterList, function (o) {
    ...
    console.error(e);
    _utils_ui__WEBPACK_IMPORTED_MODULE_2__.default.createAlert("error", `Couldn't get selected printer list: ${e}`, 0, "clicked");
    return [];
  }
}

async function bulkOctoPrintPluginUpdate() {
  try {
    let currentPrinterList = await _services_octofarm_client_service_js__WEBPACK_IMPORTED_MODULE_1__.default.listPrinters();
    let message = "";
    let toUpdate = [];
    let pluginList = [];
    ...
    if (toUpdate.length < 1) {
      _utils_ui__WEBPACK_IMPORTED_MODULE_2__.default.createAlert("error", "There are no plugin updates available!", 0, "clicked");
      return;
    }
    ...
    bootbox.confirm({
      ...
      callback: async function (result) {
        if (result) {
          (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.showBulkActionsModal)();
          (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(0, toUpdate.length);
          (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.generateTableRows)(toUpdate);
          for (let i = 0; i < toUpdate.length; i++) {
            const response = await (0,_services_octoprint_octoprint_plugin_commands__WEBPACK_IMPORTED_MODULE_4__.updateOctoPrintPlugins)(pluginList, toUpdate[i]);
            (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateTableRow)(toUpdate[i]._id, response.status, response.message);
            (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(i, toUpdate.length);
          }
          (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(toUpdate.length, toUpdate.length);
        }
      }
    });
  } catch (e) {
    console.error(e);
    _utils_ui__WEBPACK_IMPORTED_MODULE_2__.default.createAlert(
      "error",
...
async function bulkOctoPrintClientUpdate() {
  try {
    let currentPrinterList = await _services_octofarm_client_service_js__WEBPACK_IMPORTED_MODULE_1__.default.listPrinters();
    let message = "";
    let toUpdate = [];
    ...
    if (toUpdate.length < 1) {
      _utils_ui__WEBPACK_IMPORTED_MODULE_2__.default.createAlert("error", "There are no OctoPrint updates available!", 0, "clicked");
      return;
    }
    message += "Are you sure?";
    bootbox.confirm({
      ...
      callback: async function (result) {
        if (result) {
          ...
          (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.generateTableRows)(toUpdate);
          for (let i = 0; i < toUpdate.length; i++) {
            const response = await (0,_services_octoprint_octoprint_client_commands__WEBPACK_IMPORTED_MODULE_5__.updateOctoPrintClient)(toUpdate[i]);
            (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateTableRow)(toUpdate[i]._id, response.status, response.message);
            (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(i, toUpdate.length);
          }
          (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(toUpdate.length, toUpdate.length);
...
async function bulkConnectPrinters() {
  const printersToControl = await getCurrentlySelectedPrinterList();
  (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.showBulkActionsModal)();
  (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(0, printersToControl.length);
  (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.generateTableRows)(printersToControl);
  for (let p = 0; p < printersToControl.length; p++) {
    const response = await (0,_services_octoprint_octoprint_client_commands__WEBPACK_IMPORTED_MODULE_5__.quickConnectPrinterToOctoPrint)(printersToControl[p]);
    (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateTableRow)(printersToControl[p]._id, response.status, response.message);
    (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(p, printersToControl.length);
  }
  (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(printersToControl.length, printersToControl.length);
}

async function bulkDisablePrinters() {
  const printersToControl = await getCurrentlySelectedPrinterList();
  (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.showBulkActionsModal)();
  (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(0, printersToControl.length);
  (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.generateTableRows)(printersToControl);
  for (let p = 0; p < printersToControl.length; p++) {
    await _services_octofarm_client_service_js__WEBPACK_IMPORTED_MODULE_1__.default.disablePrinter(printersToControl[p]._id);
    ...
    (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateTableRow)(printersToControl[p]._id, "success", "Successfully Disabled your printer!");
    (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(p, printersToControl.length);
  }
  (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(printersToControl.length, printersToControl.length);
}

async function bulkEnablePrinters(disabled) {
    const printersToControl = await getCurrentlySelectedPrinterList(disabled);
    (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.showBulkActionsModal)();
    (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(0, printersToControl.length);
    (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.generateTableRows)(printersToControl);
    for (let p = 0; p < printersToControl.length; p++) {
      await _services_octofarm_client_service_js__WEBPACK_IMPORTED_MODULE_1__.default.enablePrinter(printersToControl[p]._id);
      const printerCard = document.getElementById(`printerCard-${printersToControl[p]._id}`);
      ...
      (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateTableRow)(printersToControl[p]._id, "success", "Successfully Enabled your printer!");
      (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(p, printersToControl.length);
    }
    (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(printersToControl.length, printersToControl.length);
}
  ...
  return new Promise(function (resolve, reject) {
    ...
    xhr.onloadend = async function (e) {
      if (this.status >= 200 && this.status < 300) {
        resolve({
          status: _bulk_actions_constants__WEBPACK_IMPORTED_MODULE_13__.default.SUCCESS,
          message: "Successfully uploaded your file! Printing started."
        });
        // Success!
      } else {
        resolve({
          status: _bulk_actions_constants__WEBPACK_IMPORTED_MODULE_13__.default.ERROR,
...
async function bulkPrintFileSetup() {
  ...
  document.getElementById("bpuploadFilesElement").innerHTML = `<div class="custom-file">
          <input type="file" accept="${_constants_file_types_constants__WEBPACK_IMPORTED_MODULE_14__.allowedFileTypes}" class="custom-file-input" id="bpFileUpload" multiple>
  ...
  let uniqueFolderList = await _services_octofarm_client_service_js__WEBPACK_IMPORTED_MODULE_1__.default.getOctoPrintUniqueFolders();
  ...
  async function runUpload() {
    ...
    for (let p = 0; p < printersToControl.length; p++) {
      ...
      if (selectedFiles.length === 1) {
        const doesFileExist = await _services_octoprint_client_service__WEBPACK_IMPORTED_MODULE_16__.default.checkFile(
          currentPrinter,
        ...
        if (doesFileExist === 200) {
          ...
          await _services_octoprint_client_service__WEBPACK_IMPORTED_MODULE_16__.default.updateFeedAndFlow(currentPrinter);
          await _services_octoprint_client_service__WEBPACK_IMPORTED_MODULE_16__.default.updateFilamentOffsets(currentPrinter);
          console.log("RUN UPLOAD FOLDER", selectedFolder);
          const url = "files/local/" + selectedFolder + selectedFiles[0].name.replaceAll(" ", "_");
          const file = await _services_octoprint_client_service__WEBPACK_IMPORTED_MODULE_16__.default.post(currentPrinter, url, opt);
          if (file.status === 204) {
            (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateTableRow)(
              currentPrinter._id,
              _bulk_actions_constants__WEBPACK_IMPORTED_MODULE_13__.default.SUCCESS,
              "File exists... print has successfully started!"
            );
          } else {
            (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateTableRow)(
              currentPrinter._id,
              _bulk_actions_constants__WEBPACK_IMPORTED_MODULE_13__.default.ERROR,
          ...
          (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateTableRow)(
            currentPrinter._id,
            _bulk_actions_constants__WEBPACK_IMPORTED_MODULE_13__.default.SKIPPED,
            `
            <div class="progress">
          ...
          (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateTableRow)(currentPrinter._id, response.status, response.message, true);
        }
    ...
    for (let p = 0; p < printersToControl.length; p++) {
      await _services_octofarm_client_service_js__WEBPACK_IMPORTED_MODULE_1__.default.post("printers/resyncFile", {
  ...
  async function checkIfPathExistsOnOctoPrint() {
    for (let i = 0; i < printersToControl.length; i++) {
      ...
      const doesFolderExist = await _services_octoprint_client_service__WEBPACK_IMPORTED_MODULE_16__.default.checkFile(currentPrinter, selectedFolder);
...
async function bulkDisconnectPrinters() {
  const printersToDisconnect = await getCurrentlySelectedPrinterList();
  (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.showBulkActionsModal)();
  (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(0, printersToDisconnect.length);
  (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.generateTableRows)(printersToDisconnect);
  for (let p = 0; p < printersToDisconnect.length; p++) {
    const response = await (0,_services_octoprint_octoprint_client_commands__WEBPACK_IMPORTED_MODULE_5__.disconnectPrinterFromOctoPrint)(printersToDisconnect[p]);
    (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateTableRow)(printersToDisconnect[p]._id, response.status, response.message);
    (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(p, printersToDisconnect.length);
  }
  (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(printersToDisconnect.length, printersToDisconnect.length);
}

function bulkOctoPrintPowerCommand() {
  bootbox.prompt({
    title: "Power command!",
    ...
    callback: async function (result) {
      ...
      (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.showBulkActionsModal)();
      (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(0, printersToPower.length);
      (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.generateTableRows)(printersToPower);
      for (let p = 0; p < printersToPower.length; p++) {
        const response = await (0,_services_octoprint_octoprint_client_commands__WEBPACK_IMPORTED_MODULE_5__.sendPowerCommandToOctoPrint)(printersToPower[p], result);
        (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateTableRow)(printersToPower[p]._id, response.status, response.message);
        (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(p, printersToPower.length);
      }
      (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(printersToPower.length, printersToPower.length);
    }
  });
}

function bulkOctoPrintPreHeatCommand() {
  bootbox.dialog({
    ...
    buttons: {
      action: {
        ...
        callback: async function () {
          ...
          (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.showBulkActionsModal)();
          (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(0, printersToPreHeat.length);
          (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.generateTableRows)(printersToPreHeat);
          for (let p = 0; p < printersToPreHeat.length; p++) {
            let response;
            if (toolTemp.value && toolTemp.value > 0) {
              response = await (0,_services_octoprint_octoprint_printer_commands__WEBPACK_IMPORTED_MODULE_6__.printerPreHeatTool)(printersToPreHeat[p], toolTemp, toolNumber);
              (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateTableRow)(printersToPreHeat[p]._id, response.status, response.message);
              (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(p, printersToPreHeat.length);
            }
            if (bedTemp.value !== "" && bedTemp.value > 0) {
              response = await (0,_services_octoprint_octoprint_printer_commands__WEBPACK_IMPORTED_MODULE_6__.printerPreHeatBed)(printersToPreHeat[p], bedTemp);
              (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateTableRow)(printersToPreHeat[p]._id, response.status, response.message);
              (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(p, printersToPreHeat.length);
            }
            if (chamberTemp.value !== "" && chamberTemp.value > 0) {
              response = await (0,_services_octoprint_octoprint_printer_commands__WEBPACK_IMPORTED_MODULE_6__.printerPreHeatChamber)(printersToPreHeat[p], chamberTemp);
              (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateTableRow)(printersToPreHeat[p]._id, response.status, response.message);
              (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(p, printersToPreHeat.length);
            }
          }
          (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(printersToPreHeat.length, printersToPreHeat.length);
        }
      }
    }
  });
...
async function bulkOctoPrintControlCommand() {
  const printersToControl = await getCurrentlySelectedPrinterList();
  let cameraBlock = "";
  printersToControl.forEach((printer) => {
  ...
  bootbox.dialog({
    ...
    onShow: function (e) {
      ...
      printerControls.printStart.addEventListener("click", (e) => {
        printersToControl.forEach((printer) => {
          (0,_services_octoprint_octoprint_printer_commands__WEBPACK_IMPORTED_MODULE_6__.printerStartPrint)(printer, e);
        });
      });
      printerControls.printPause.addEventListener("click", (e) => {
        printersToControl.forEach((printer) => {
          (0,_services_octoprint_octoprint_printer_commands__WEBPACK_IMPORTED_MODULE_6__.printerPausePrint)(printer, e);
        });
      });
      printerControls.printRestart.addEventListener("click", (e) => {
        printersToControl.forEach((printer) => {
          (0,_services_octoprint_octoprint_printer_commands__WEBPACK_IMPORTED_MODULE_6__.printerRestartPrint)(printer, e);
        });
      });
      printerControls.printResume.addEventListener("click", (e) => {
        printersToControl.forEach((printer) => {
          (0,_services_octoprint_octoprint_printer_commands__WEBPACK_IMPORTED_MODULE_6__.printerResumePrint)(printer, e);
        });
      });
      printerControls.printStop.addEventListener("click", (e) => {
        bootbox.confirm({
          ...
          callback(result) {
            if (result) {
              printersToControl.forEach((printer) => {
                (0,_services_octoprint_octoprint_printer_commands__WEBPACK_IMPORTED_MODULE_6__.printerStopPrint)(printer, e);
              });
            }
          }
        });
      ...
      printerControls.xPlus.addEventListener("click", (e) => {
        printersToControl.forEach((printer) => {
          (0,_services_octoprint_octoprint_printer_commands__WEBPACK_IMPORTED_MODULE_6__.printerMoveAxis)(e, printer, "x");
        });
      });
      ...
      printerControls.yPlus.addEventListener("click", (e) => {
        printersToControl.forEach((printer) => {
          (0,_services_octoprint_octoprint_printer_commands__WEBPACK_IMPORTED_MODULE_6__.printerMoveAxis)(e, printer, "y");
        });
      });
      ...
      printerControls.xyHome.addEventListener("click", (e) => {
        printersToControl.forEach((printer) => {
          (0,_services_octoprint_octoprint_printer_commands__WEBPACK_IMPORTED_MODULE_6__.printerHomeAxis)(e, printer, ["x", "y"]);
        });
      });
      printerControls.zPlus.addEventListener("click", (e) => {
        printersToControl.forEach((printer) => {
          (0,_services_octoprint_octoprint_printer_commands__WEBPACK_IMPORTED_MODULE_6__.printerMoveAxis)(e, printer, "z");
        });
      });
      ...
      printerControls.zHome.addEventListener("click", (e) => {
        printersToControl.forEach((printer) => {
          (0,_services_octoprint_octoprint_printer_commands__WEBPACK_IMPORTED_MODULE_6__.printerHomeAxis)(e, printer, ["z"]);
        });
      });
      printerControls.step01.addEventListener("click", (e) => {
        printersToControl.forEach((printer) => {
          _services_octofarm_client_service_js__WEBPACK_IMPORTED_MODULE_1__.default.post("printers/stepChange", {
            printer: printer._id,
            newSteps: "01"
          });
        });
...
async function bulkOctoPrintGcodeCommand() {
  ...
  bootbox.prompt({
    ...
    onShow: async function (e) {
      ...
      const gcodeButtons = await _services_octofarm_client_service_js__WEBPACK_IMPORTED_MODULE_1__.default.getCustomGcode();
      let area = document.getElementById("customGcodeCommandsArea");
      if (area) {
        gcodeButtons.forEach((scripts) => {
          let button = _services_custom_gcode_scripts_service__WEBPACK_IMPORTED_MODULE_8__.default.getButton(scripts);
          area.insertAdjacentHTML("beforeend", button);
          document.getElementById("gcode-" + scripts._id).addEventListener("click", async (e) => {
            (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.showBulkActionsModal)();
            (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(0, printersToSendGcode.length);
            (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.generateTableRows)(printersToSendGcode);
            for (let p = 0; p < printersToSendGcode.length; p++) {
              ...
              if (
                ...
                let post = await _services_custom_gcode_scripts_service__WEBPACK_IMPORTED_MODULE_8__.default.fireCommand(
                  scripts._id,
                  scripts.gcode,
                  printersToSendGcode[p]
                );
                (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(p, printersToSendGcode.length);
                if (post.status === 204) {
                  (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateTableRow)(
            ...
            (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(printersToSendGcode.length, printersToSendGcode.length);
          });
        });
      }
    },
    callback: async function (result) {
      if (result) {
        ...
        (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.generateTableRows)(printersToSendGcode);
        for (let p = 0; p < printersToSendGcode.length; p++) {
          let response = await (0,_services_octoprint_octoprint_printer_commands__WEBPACK_IMPORTED_MODULE_6__.printerSendGcode)(printersToSendGcode[p], result);
          (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateTableRow)(printersToSendGcode[p]._id, response.status, response.message);
        }
        (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(printersToSendGcode.length, printersToSendGcode.length);
      }
    }
...
async function bulkOctoPrintPluginAction(action) {
  const printersForPluginAction = await getCurrentlySelectedPrinterList();
  try {
    let pluginList = [];
    if (action === "install") {
      const pluginRepositoryList = await _services_octofarm_client_service_js__WEBPACK_IMPORTED_MODULE_1__.default.get("printers/pluginList");
      pluginRepositoryList.forEach((plugin) => {
        pluginList.push({
          text: (0,_templates_octoprint_plugin_list_template__WEBPACK_IMPORTED_MODULE_10__.returnPluginListTemplate)(plugin),
      ...
      for (let i = 0; i < idList.length; i++) {
        if (action === "enable") {
          try {
            const disabledPluginList = await _services_octofarm_client_service_js__WEBPACK_IMPORTED_MODULE_1__.default.get(
              "printers/disabledPluginList/" + idList[i]
            );
            disabledPluginList.forEach((plugin) => {
              pluginList.push({
                text: (0,_templates_octoprint_plugin_list_template__WEBPACK_IMPORTED_MODULE_10__.returnPluginSelectTemplate)(plugin),
                value: plugin.key
              });
            });
          } catch (e) {
        ...
        if (action === "disable") {
          try {
            const enabledPluginList = await _services_octofarm_client_service_js__WEBPACK_IMPORTED_MODULE_1__.default.get(
        ...
        if (action === "uninstall") {
          try {
            const allInstalledPlugins = await _services_octofarm_client_service_js__WEBPACK_IMPORTED_MODULE_1__.default.get(
    ...
    bootbox.prompt({
      ...
      scrollable: true,
      onShow: function (e) {
        (0,_plugin_search_function__WEBPACK_IMPORTED_MODULE_9__.setupPluginSearch)();
      },
      callback: async function (result) {
        if (result) {
          ...
          (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.showBulkActionsModal)();
          (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(0, printersForPluginAction.length);
          (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.generateTableRows)(printersForPluginAction);
          for (let p = 0; p < printersForPluginAction.length; p++) {
            const response = await (0,_services_octoprint_octoprint_plugin_commands__WEBPACK_IMPORTED_MODULE_4__.octoPrintPluginInstallAction)(
              printersForPluginAction[p],
              result,
              action
            );
            (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateTableRow)(printersForPluginAction[p]._id, response.status, response.message);
            (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(p, printersForPluginAction.length);
          }
          (0,_bulk_actions_progress_functions__WEBPACK_IMPORTED_MODULE_11__.updateBulkActionsProgress)(printersForPluginAction.length, printersForPluginAction.length);
        }
      }
    });
  } catch (e) {
...
async function bulkEnableVirtualPrinter() {
  const printers = await _services_octofarm_client_service_js__WEBPACK_IMPORTED_MODULE_1__.default.listPrinters();
  const alert = _utils_ui__WEBPACK_IMPORTED_MODULE_2__.default.createAlert(
    "warning",
    `${_utils_ui__WEBPACK_IMPORTED_MODULE_2__.default.returnSpinnerTemplate()} Setting up your OctoPrint settings, please wait...`
  );

  const { successfulPrinters, failedPrinters } = await (0,_services_octoprint_octoprint_settings_actions__WEBPACK_IMPORTED_MODULE_7__.setupOctoPrintForVirtualPrinter)(printers);

  alert.close();
  bootbox.alert(successfulPrinters + failedPrinters);
}

async function bulkUpdateOctoPrintSettings() {
  const printersForSettingsAction = await getCurrentlySelectedPrinterList();
  const getSettingsList = await _services_octoprint_client_service__WEBPACK_IMPORTED_MODULE_16__.default.get(printersForSettingsAction[0], "api/settings");
  if (getSettingsList?.status === 200) {
    ...
    (0,_bulk_settings_update_functions__WEBPACK_IMPORTED_MODULE_12__.populateBulkSettingsForms)({appearance,
      gcodeAnalysis,
      plugins, //Special Case, it's it's own settings set...
      scripts,
      serial,
    ...
    _utils_ui__WEBPACK_IMPORTED_MODULE_2__.default.createAlert("danger", "Failed to grab latest settings list...", 3000, "Clicked");
  }
}
...
setInterval(async () => {
  ...
  if (fileUploads.size() > 0) {
    ...
    if (!current.active) {
      ...
      const post = await _services_octofarm_client_service_js__WEBPACK_IMPORTED_MODULE_1__.default.post("printers/newFiles", file);
...
/***/ "./js/pages/printer-manager/functions/bulk-settings-update.functions.js":
/*!******************************************************************************!*\
  !*** ./js/pages/printer-manager/functions/bulk-settings-update.functions.js ***!
  \******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "populateBulkSettingsForms": () => (/* binding */ populateBulkSettingsForms)
/* harmony export */ });
/* harmony import */ var _utils_ui__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../utils/ui */ "./js/utils/ui.js");
        ...
        switch(key){
            ...
            default:
                if(typeof value === "boolean"){
                    checkBoxHTML += _utils_ui__WEBPACK_IMPORTED_MODULE_0__.default.convertValueToTemplate(key, value);
                }else{
                    buttonsHTML += _utils_ui__WEBPACK_IMPORTED_MODULE_0__.default.convertValueToTemplate(key, value);
                }
        }
...
function populateBulkSettingsForms(settings){
    ...
    for (const key of Object.keys(settings)) {
        ...
        _utils_ui__WEBPACK_IMPORTED_MODULE_0__.default.removeLoaderFromElementInnerHTML(document.getElementById(`bulk-${key}-settings-btn`))
...
/***/ "./js/pages/printer-manager/functions/plugin-search.function.js":
/*!**********************************************************************!*\
  !*** ./js/pages/printer-manager/functions/plugin-search.function.js ***!
  \**********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "setupPluginSearch": () => (/* binding */ setupPluginSearch)
/* harmony export */ });
function setupPluginSearch() {
...
/***/ "./js/pages/printer-manager/templates/octoprint-plugin-list.template.js":
/*!******************************************************************************!*\
  !*** ./js/pages/printer-manager/templates/octoprint-plugin-list.template.js ***!
  \******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "returnPluginListTemplate": () => (/* binding */ returnPluginListTemplate),
/* harmony export */   "returnPluginSelectTemplate": () => (/* binding */ returnPluginSelectTemplate)
/* harmony export */ });
function returnPluginListTemplate(plugin) {
...
function returnPluginSelectTemplate(plugin) {
  return `
...
/***/ "./js/services/octoprint/octoprint-client-commands.js":
/*!************************************************************!*\
  !*** ./js/services/octoprint/octoprint-client-commands.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "setupUpdateOctoPrintClientBtn": () => (/* binding */ setupUpdateOctoPrintClientBtn),
/* harmony export */   "updateOctoPrintClient": () => (/* binding */ updateOctoPrintClient),
/* harmony export */   "quickConnectPrinterToOctoPrint": () => (/* binding */ quickConnectPrinterToOctoPrint),
/* harmony export */   "disconnectPrinterFromOctoPrint": () => (/* binding */ disconnectPrinterFromOctoPrint),
/* harmony export */   "sendPowerCommandToOctoPrint": () => (/* binding */ sendPowerCommandToOctoPrint)
/* harmony export */ });
/* harmony import */ var _octoprint_client_service_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../octoprint-client.service.js */ "./js/services/octoprint-client.service.js");
/* harmony import */ var _utils_ui__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils/ui */ "./js/utils/ui.js");
/* harmony import */ var _octofarm_client_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../octofarm-client.service */ "./js/services/octofarm-client.service.js");
/* harmony import */ var _pages_printer_manager_bulk_actions_constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../pages/printer-manager/bulk-actions.constants */ "./js/pages/printer-manager/bulk-actions.constants.js");
...
async function updateBtnOnClick(printerID) {
  try {
    const printer = await _octofarm_client_service__WEBPACK_IMPORTED_MODULE_2__.default.getPrinter(printerID);
    bootbox.confirm({
    ...
    console.error(e);
    _utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.createAlert("error", `Unable to grab latest printer information: ${e}`, 0, "clicked");
  }
}

function setupUpdateOctoPrintClientBtn(printer) {
...
async function updateOctoPrintClient(printer) {
  const data = {
    targets: ["octoprint"],
    force: true
  };
  let updateRequest = await _octoprint_client_service_js__WEBPACK_IMPORTED_MODULE_0__.default.postNOAPI(
    printer,
    "plugin/softwareupdate/update",
    data
  );
  if (updateRequest.status === 200) {
    _utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.createAlert("success", "Update command fired!", 3000, "clicked");
    return {
      status: _pages_printer_manager_bulk_actions_constants__WEBPACK_IMPORTED_MODULE_3__.default.SUCCESS,
    ...
    return {
      status: _pages_printer_manager_bulk_actions_constants__WEBPACK_IMPORTED_MODULE_3__.default.ERROR,
      message:
        "OctoPrint responded with a status of: " +
        post.status +
        "... there may be bugs on your instance!"
...
async function quickConnectPrinterToOctoPrint(printer) {
  let data = {};
  ...
  if (printer.printerState.colour.category === "Disconnected") {
    const post = await _octoprint_client_service_js__WEBPACK_IMPORTED_MODULE_0__.default.post(printer, "connection", data);
    if (typeof post !== "undefined") {
      if (post.status === 204) {
        return { status: _pages_printer_manager_bulk_actions_constants__WEBPACK_IMPORTED_MODULE_3__.default.SUCCESS, message: "Connection attempt was successful!" };
      } else {
        return {
          status: _pages_printer_manager_bulk_actions_constants__WEBPACK_IMPORTED_MODULE_3__.default.ERROR,
          message:
    ...
    return {
      status: _pages_printer_manager_bulk_actions_constants__WEBPACK_IMPORTED_MODULE_3__.default.SKIPPED,
      message: "Skipped connecting because printer wasn't in disconnected state..."
    };
  }
}

async function disconnectPrinterFromOctoPrint(printer) {
  let data = {
    command: "disconnect"
  };
  if (printer.printerState.colour.category === "Idle") {
    let post = await _octoprint_client_service_js__WEBPACK_IMPORTED_MODULE_0__.default.post(printer, "connection", data);
    if (typeof post !== "undefined") {
      if (post.status === 204) {
        return { status: _pages_printer_manager_bulk_actions_constants__WEBPACK_IMPORTED_MODULE_3__.default.SUCCESS, message: "Disconnect attempt was successful!" };
      } else {
        return {
          status: _pages_printer_manager_bulk_actions_constants__WEBPACK_IMPORTED_MODULE_3__.default.ERROR,
          message:
...
async function sendPowerCommandToOctoPrint(printer, powerCommand) {
  if (printer.printerState.colour.category !== "Active") {
    let post = await _octoprint_client_service_js__WEBPACK_IMPORTED_MODULE_0__.default.systemNoConfirm(printer, powerCommand);
    await _utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.delay(1000);
    if (typeof post !== "undefined") {
      if (post.status === 204) {
        return {
          status: _pages_printer_manager_bulk_actions_constants__WEBPACK_IMPORTED_MODULE_3__.default.SUCCESS,
...
/***/ "./js/services/octoprint/octoprint-plugin-commands.js":
/*!************************************************************!*\
  !*** ./js/services/octoprint/octoprint-plugin-commands.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "setupUpdateOctoPrintPluginsBtn": () => (/* binding */ setupUpdateOctoPrintPluginsBtn),
/* harmony export */   "updateOctoPrintPlugins": () => (/* binding */ updateOctoPrintPlugins),
/* harmony export */   "octoPrintPluginInstallAction": () => (/* binding */ octoPrintPluginInstallAction)
/* harmony export */ });
/* harmony import */ var _octoprint_client_service_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../octoprint-client.service.js */ "./js/services/octoprint-client.service.js");
/* harmony import */ var _octofarm_client_service_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../octofarm-client.service.js */ "./js/services/octofarm-client.service.js");
/* harmony import */ var _utils_ui__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../utils/ui */ "./js/utils/ui.js");
/* harmony import */ var _pages_printer_manager_bulk_actions_constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../pages/printer-manager/bulk-actions.constants */ "./js/pages/printer-manager/bulk-actions.constants.js");
...
async function updateBtnOnClick(printerID) {
  try {
    ...
    const printer = await _octofarm_client_service_js__WEBPACK_IMPORTED_MODULE_1__.default.post(printerBase + printerInfoURL, data);
    ...
    console.error(e);
    _utils_ui__WEBPACK_IMPORTED_MODULE_2__.default.createAlert("error", `Unable to grab latest printer information: ${e}`, 0, "clicked");
  }
}

function setupUpdateOctoPrintPluginsBtn(printer) {
...
async function updateOctoPrintPlugins(pluginList, printer) {
  const data = {
    targets: pluginList,
    force: true
  };
  ...
  if (updateRequest.status === 200) {
    ...
    let post = await _octoprint_client_service_js__WEBPACK_IMPORTED_MODULE_0__.default.systemNoConfirm(printer, "restart");
    if (typeof post !== "undefined") {
      if (post.status === 204) {
        return {
          status: _pages_printer_manager_bulk_actions_constants__WEBPACK_IMPORTED_MODULE_3__.default.SUCCESS,
        ...
        return {
          status: _pages_printer_manager_bulk_actions_constants__WEBPACK_IMPORTED_MODULE_3__.default.WARNING,
...
async function octoPrintPluginInstallAction(printer, pluginList, action) {
  let cleanAction = action.charAt(0).toUpperCase() + action.slice(1);
  if (action === "install") {
    cleanAction = cleanAction + "ing";
  }
  ...
  if (printer.printerState.colour.category !== "Active") {
    for (let r = 0; r < pluginList.length; r++) {
      let alert = _utils_ui__WEBPACK_IMPORTED_MODULE_2__.default.createAlert(
        "warning",
      ...
      const post = await _octoprint_client_service_js__WEBPACK_IMPORTED_MODULE_0__.default.post(printer, "plugin/pluginmanager", postData);
      alert.close();
      if (post.status === 409) {
        return {
          status: _pages_printer_manager_bulk_actions_constants__WEBPACK_IMPORTED_MODULE_3__.default.ERROR,
...
/***/ "./js/services/octoprint/octoprint-printer-commands.js":
/*!*************************************************************!*\
  !*** ./js/services/octoprint/octoprint-printer-commands.js ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "printerPreHeatChamber": () => (/* binding */ printerPreHeatChamber),
/* harmony export */   "printerPreHeatBed": () => (/* binding */ printerPreHeatBed),
/* harmony export */   "printerPreHeatTool": () => (/* binding */ printerPreHeatTool),
/* harmony export */   "printerStartPrint": () => (/* binding */ printerStartPrint),
/* harmony export */   "printerPausePrint": () => (/* binding */ printerPausePrint),
/* harmony export */   "printerRestartPrint": () => (/* binding */ printerRestartPrint),
/* harmony export */   "printerResumePrint": () => (/* binding */ printerResumePrint),
/* harmony export */   "printerStopPrint": () => (/* binding */ printerStopPrint),
/* harmony export */   "printerMoveAxis": () => (/* binding */ printerMoveAxis),
/* harmony export */   "printerHomeAxis": () => (/* binding */ printerHomeAxis),
/* harmony export */   "printerSendGcode": () => (/* binding */ printerSendGcode)
/* harmony export */ });
/* harmony import */ var _octoprint_client_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../octoprint-client.service */ "./js/services/octoprint-client.service.js");
/* harmony import */ var _pages_printer_manager_bulk_actions_constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../pages/printer-manager/bulk-actions.constants */ "./js/pages/printer-manager/bulk-actions.constants.js");



async function printerPreHeatChamber(printer, chamberTemp) {
  let chamberData = {
    command: "target",
    target: 0
  };
  ...
  //Set chamber temp
  if (chamberTemp.value !== "" && !isNaN(chamberTemp.value)) {
    let post = await _octoprint_client_service__WEBPACK_IMPORTED_MODULE_0__.default.post(printer, "printer/chamber", chamberData);
    if (typeof post !== "undefined") {
      if (post.status === 204) {
        return {
          status: _pages_printer_manager_bulk_actions_constants__WEBPACK_IMPORTED_MODULE_1__.default.SUCCESS,
          message: "Chamber successfully set at " + chamberData.target + "°C"
        };
      } else {
        return {
          status: _pages_printer_manager_bulk_actions_constants__WEBPACK_IMPORTED_MODULE_1__.default.ERROR,
...
async function printerPreHeatBed(printer, bedTemp) {
  let bedData = {
    command: "target",
    target: 0
  };
  ...
  //Set bed temp
  if (bedTemp.value !== "" && !isNaN(bedTemp.value)) {
    let post = await _octoprint_client_service__WEBPACK_IMPORTED_MODULE_0__.default.post(printer, "printer/bed", bedData);
    if (typeof post !== "undefined") {
      if (post.status === 204) {
        return {
          status: _pages_printer_manager_bulk_actions_constants__WEBPACK_IMPORTED_MODULE_1__.default.SUCCESS,
...
async function printerPreHeatTool(printer, toolTemp, toolNumber) {
  let toolData = {
    command: "target",
    targets: {}
  };
  ...
  if (toolTemp.value !== "" && !isNaN(toolTemp.value)) {
    let post = await _octoprint_client_service__WEBPACK_IMPORTED_MODULE_0__.default.post(printer, "printer/tool", toolData);
    if (typeof post !== "undefined") {
      if (post.status === 204) {
        return {
          status: _pages_printer_manager_bulk_actions_constants__WEBPACK_IMPORTED_MODULE_1__.default.SUCCESS,
...
async function printerStartPrint(printer, e) {
  e.target.disabled = true;
  const opts = {
    command: "start"
  };
  await _octoprint_client_service__WEBPACK_IMPORTED_MODULE_0__.default.jobAction(printer, opts, e);
}

async function printerPausePrint(printer, e) {
  e.target.disabled = true;
  const opts = {
    command: "pause",
    action: "pause"
...
async function printerRestartPrint(printer, e) {
  e.target.disabled = true;
  const opts = {
    command: "restart"
  };
...
async function printerResumePrint(printer, e) {
  e.target.disabled = true;
  const opts = {
    command: "pause",
    action: "resume"
...
async function printerStopPrint(printer, e) {
  e.target.disabled = true;
  const opts = {
    command: "cancel"
  };
...
async function printerMoveAxis(e, printer, axis, dir) {
  await _octoprint_client_service__WEBPACK_IMPORTED_MODULE_0__.default.move(e, printer, "jog", axis, dir);
}

async function printerHomeAxis(e, printer, axis) {
  await _octoprint_client_service__WEBPACK_IMPORTED_MODULE_0__.default.move(e, printer, "home", axis);
}

async function printerSendGcode(printer, result) {
  ...
  const post = await _octoprint_client_service__WEBPACK_IMPORTED_MODULE_0__.default.post(printer, "printer/command", opt);
  if (post.status === 204) {
    return {
      status: _pages_printer_manager_bulk_actions_constants__WEBPACK_IMPORTED_MODULE_1__.default.SUCCESS,
...
"use strict";
/*!**********************************************!*\
  !*** ./js/bulk-action-commands.functions.js ***!
  \**********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _services_printer_selection_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./services/printer-selection.service */ "./js/services/printer-selection.service.js");
/* harmony import */ var _pages_printer_manager_functions_bulk_commands_functions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./pages/printer-manager/functions/bulk-commands-functions */ "./js/pages/printer-manager/functions/bulk-commands-functions.js");
...
if (multiPrintCommandBtn) {
  multiPrintCommandBtn.addEventListener("click", async (e) => {
    await _services_printer_selection_service__WEBPACK_IMPORTED_MODULE_0__.default.create(
      multiPrintersSection,
      false,
      "Start a Bulk Print",
      await _pages_printer_manager_functions_bulk_commands_functions__WEBPACK_IMPORTED_MODULE_1__.bulkPrintFileSetup
    );
  });
}
...
bulkGcodeCommands.addEventListener("click", async (e) => {
  await _services_printer_selection_service__WEBPACK_IMPORTED_MODULE_0__.default.create(
    ...
    await _pages_printer_manager_functions_bulk_commands_functions__WEBPACK_IMPORTED_MODULE_1__.bulkOctoPrintGcodeCommand
  );
});
...
bulkConnectBtn.addEventListener("click", async (e) => {
  await _services_printer_selection_service__WEBPACK_IMPORTED_MODULE_0__.default.create(
    ...
    false,
    "Connect Printers",
    await _pages_printer_manager_functions_bulk_commands_functions__WEBPACK_IMPORTED_MODULE_1__.bulkConnectPrinters
  );
});
...
bulkDisconnectBtn.addEventListener("click", async (e) => {
  await _services_printer_selection_service__WEBPACK_IMPORTED_MODULE_0__.default.create(
    ...
    false,
    "Disconnect Printers",
    await _pages_printer_manager_functions_bulk_commands_functions__WEBPACK_IMPORTED_MODULE_1__.bulkDisconnectPrinters
  );
});
...
bulkPowerBtn.addEventListener("click", async (e) => {
  await _services_printer_selection_service__WEBPACK_IMPORTED_MODULE_0__.default.create(
    ...
    await _pages_printer_manager_functions_bulk_commands_functions__WEBPACK_IMPORTED_MODULE_1__.bulkOctoPrintPowerCommand
  );
});
...
bulkPreHeat.addEventListener("click", async (e) => {
  await _services_printer_selection_service__WEBPACK_IMPORTED_MODULE_0__.default.create(
    ...
    false,
    "Pre-Heat Printers",
    await _pages_printer_manager_functions_bulk_commands_functions__WEBPACK_IMPORTED_MODULE_1__.bulkOctoPrintPreHeatCommand
  );
});
...
bulkControl.addEventListener("click", async (e) => {
  await _services_printer_selection_service__WEBPACK_IMPORTED_MODULE_0__.default.create(
    ...
    false,
    "Control Printers",
    await _pages_printer_manager_functions_bulk_commands_functions__WEBPACK_IMPORTED_MODULE_1__.bulkOctoPrintControlCommand
  );
});
