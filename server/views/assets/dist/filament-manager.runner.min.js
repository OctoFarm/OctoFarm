...
"use strict";
/*!***************************************!*\
  !*** ./js/filament-manager.runner.js ***!
  \***************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utils_ui_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/ui.js */ "./js/utils/ui.js");
/* harmony import */ var _services_filament_manager_plugin_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./services/filament-manager-plugin.service */ "./js/services/filament-manager-plugin.service.js");
...
/* harmony import */ var _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./services/octofarm-client.service */ "./js/services/octofarm-client.service.js");
/* harmony import */ var _pages_charts_dashboard_options__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./pages/charts/dashboard.options */ "./js/pages/charts/dashboard.options.js");
...
async function reRenderPageInformation() {
  let { statistics, spools } = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_3__.default.getFilamentStatistics();
...
async function addProfile(manufacturer, material, density, diameter) {
  ...
  if (errors.length > 0) {
    errors.forEach((error) => {
      _utils_ui_js__WEBPACK_IMPORTED_MODULE_0__.default.createMessage(error, "profilesMessage");
    });
    return;
  }
  const opts = {
  ...
  let post = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_3__.default.post("filament/save/profile", opts);
  if (post) {
    _utils_ui_js__WEBPACK_IMPORTED_MODULE_0__.default.createMessage(
      {
        type: "success",
...
async function saveProfile(e) {
  ...
  let post = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_3__.default.post("filament/edit/profile", data);
  if (post) {
    await reRenderPageInformation();
    await updateProfileDrop();
...
async function deleteProfile(e) {
  ...
  if (e.classList.contains("delete") || e.classList.contains("deleteIcon")) {
    let post = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_3__.default.post("filament/delete/profile", {
...
async function addSpool(
  ...
  if (errors.length > 0) {
    errors.forEach((error) => {
      _utils_ui_js__WEBPACK_IMPORTED_MODULE_0__.default.createMessage(error, "addSpoolsMessage");
    });
    return;
  }
  const opts = {
  ...
  let post = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_3__.default.post("filament/save/filament", opts);
...
async function deleteSpool(e) {
  document.getElementById("profilesMessage").innerHTML = "";
  if (e.classList.contains("delete") || e.classList.contains("deleteIcon")) {
    let post = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_3__.default.post("filament/delete/filament", {
      id: e.parentElement.parentElement.firstElementChild.innerHTML.trim()
    });
    if (post?.spool) {
      await reRenderPageInformation();
...
async function saveSpool(e) {
  ...
  let post = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_3__.default.post("filament/edit/filament", data);
  if (post) {
...
async function updateProfileDrop() {
  ...
  let profiles = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_3__.default.get("filament/get/profile");
  let fill = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_3__.default.get("filament/get/filament");
  let profile = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_3__.default.get("filament/get/profile");
  if (!!profiles) {
...
async function updatePrinterDrops() {
  let filament = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_3__.default.get("filament/get/filament");
  let { printerList } = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_3__.default.get("filament/get/printerList");
  let printerDropList = "";
...
async function selectFilament(spools, id) {
  ...
  await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_3__.default.post("/filament/assign", {
    printers: printerIds,
    spoolId: id
  });
...
async function init() {
  let historyStatistics = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_3__.default.getHistoryStatistics();
  ...
  if (typeof usageOverTime[0] !== "undefined") {
    let systemFarmTemp = new apexcharts__WEBPACK_IMPORTED_MODULE_2__(
      document.querySelector("#usageOverTime"),
      _pages_charts_dashboard_options__WEBPACK_IMPORTED_MODULE_4__.dashboardOptions.filamentUsageByDayChartOptions
    );
    await systemFarmTemp.render();
    let usageOverFilamentTime = new apexcharts__WEBPACK_IMPORTED_MODULE_2__(
      document.querySelector("#usageOverFilamentTime"),
      _pages_charts_dashboard_options__WEBPACK_IMPORTED_MODULE_4__.dashboardOptions.filamentUsageOverTimeChartOptions
    );
  ...
  await (0,_services_filament_manager_plugin_service__WEBPACK_IMPORTED_MODULE_1__.setupFilamentManagerReSyncBtn)();
