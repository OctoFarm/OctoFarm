...
/***/ "./js/pages/charts/charts.manager.js":
/*!*******************************************!*\
  !*** ./js/pages/charts/charts.manager.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ChartsManager": () => (/* binding */ ChartsManager)
/* harmony export */ });
...
/* harmony import */ var _dashboard_options__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dashboard.options */ "./js/pages/charts/dashboard.options.js");
...
async function renderChart(elementId, options) {
  ...
  if (chartContainerElement) {
    const chartElement = new (apexcharts__WEBPACK_IMPORTED_MODULE_0___default())(chartContainerElement, options);
...
class ChartsManager {
  ...
  static async renderDefaultCharts() {
    hourlyTotalTemperatureChart = await renderChart(
      ...
      _dashboard_options__WEBPACK_IMPORTED_MODULE_1__.dashboardOptions.optionsHourlyTemperature
    );
    weeklyUtilisationPerDayHeatMapChart = await renderChart(
      chartIds.weeklyUtilisationPerDayHeatMap,
      _dashboard_options__WEBPACK_IMPORTED_MODULE_1__.dashboardOptions.optionsWeeklyUtilisationPerDayHeatMap
    );
    currentStatusChart = await renderChart(
      chartIds.currentStatusChart,
      _dashboard_options__WEBPACK_IMPORTED_MODULE_1__.dashboardOptions.currentStatusChartOptions
    );
    currentUtilisationChart = await renderChart(
      chartIds.currentUtilisationChart,
      _dashboard_options__WEBPACK_IMPORTED_MODULE_1__.dashboardOptions.optionsCurrentUtilisationChart
    );
  }

  static async renderFilamentUsageOverTimeChart(seriesData, yAxis) {
    _dashboard_options__WEBPACK_IMPORTED_MODULE_1__.dashboardOptions.filamentUsageOverTimeChartOptions.yaxis = yAxis;
    filamentUsageOverTimeChart = await renderChart(
      chartIds.filamentUsageOverTimeChart,
      _dashboard_options__WEBPACK_IMPORTED_MODULE_1__.dashboardOptions.filamentUsageOverTimeChartOptions
    );
    this.updateFilamentOverTimeChartSeries(seriesData);
  }

  static async renderFilamentUsageByDayChart(seriesData, yAxis) {
    _dashboard_options__WEBPACK_IMPORTED_MODULE_1__.dashboardOptions.filamentUsageByDayChartOptions.yaxis = yAxis;
    filamentUsageByDay = await renderChart(
      chartIds.filamentUsageByDayChart,
      _dashboard_options__WEBPACK_IMPORTED_MODULE_1__.dashboardOptions.filamentUsageByDayChartOptions
    );
  ...
  static async renderPrintCompletionByDay(seriesData) {
    historyGraph = await renderChart(
      ...
      _dashboard_options__WEBPACK_IMPORTED_MODULE_1__.dashboardOptions.printCompletionByDayChartOptions
    );
  ...
  static async renderEnvironmentDataChart(seriesData, labels) {
    const environmentalHistoryChartOptions = _dashboard_options__WEBPACK_IMPORTED_MODULE_1__.dashboardOptions.environmentalDataChartOptions;
...
/***/ "./js/pages/dashboard/dashboard-sse.handler.js":
/*!*****************************************************!*\
  !*** ./js/pages/dashboard/dashboard-sse.handler.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "dashboardSSEventHandler": () => (/* binding */ dashboardSSEventHandler)
/* harmony export */ });
/* harmony import */ var _dashboard_updater__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dashboard.updater */ "./js/pages/dashboard/dashboard.updater.js");
/* harmony import */ var _utils_ui__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils/ui */ "./js/utils/ui.js");
/* harmony import */ var _services_current_operations_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/current-operations.service */ "./js/services/current-operations.service.js");
...
async function dashboardSSEventHandler(data) {
  if (data) {
    ...
    if (dashboardSettings.farmActivity.currentOperations) {
      (0,_services_current_operations_service__WEBPACK_IMPORTED_MODULE_2__.default)(currentOperationsData.operations, currentOperationsData.count, printerInfo);
    }

    _dashboard_updater__WEBPACK_IMPORTED_MODULE_0__.DashUpdate.farmInformation(
    ...
    if (dashboardSettings.farmUtilisation.farmUtilisation) {
      _dashboard_updater__WEBPACK_IMPORTED_MODULE_0__.DashUpdate.farmUtilisation(dashboard.farmUtilisation);
    }

    _dashboard_updater__WEBPACK_IMPORTED_MODULE_0__.DashUpdate.currentStatusAndUtilisation(
    ...
    if (dashboardSettings.printerStates.printerState) {
      _dashboard_updater__WEBPACK_IMPORTED_MODULE_0__.DashUpdate.printerStatus(dashboard.printerHeatMaps.heatStatus);
    }

    if (dashboardSettings.printerStates.printerProgress) {
      _dashboard_updater__WEBPACK_IMPORTED_MODULE_0__.DashUpdate.printerProgress(dashboard.printerHeatMaps.heatProgress);
    }
    if (dashboardSettings.printerStates.printerTemps) {
      _dashboard_updater__WEBPACK_IMPORTED_MODULE_0__.DashUpdate.printerTemps(dashboard.printerHeatMaps.heatTemps);
    }
    if (dashboardSettings.printerStates.printerUtilisation) {
      _dashboard_updater__WEBPACK_IMPORTED_MODULE_0__.DashUpdate.printerUptime(dashboard.printerHeatMaps.heatUtilisation);
    }

    if (dashboardSettings.historical.environmentalHistory) {
      await _dashboard_updater__WEBPACK_IMPORTED_MODULE_0__.DashUpdate.environmentalData(dashboard.enviromentalData);
    }
    if (dashboardSettings.other.timeAndDate) {
      _dashboard_updater__WEBPACK_IMPORTED_MODULE_0__.DashUpdate.dateAndTime();
    }
  } else {
...
/***/ "./js/pages/dashboard/dashboard.storage.js":
/*!*************************************************!*\
  !*** ./js/pages/dashboard/dashboard.storage.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "DashboardStorage": () => (/* binding */ DashboardStorage)
/* harmony export */ });
...
/***/ "./js/pages/dashboard/dashboard.updater.js":
/*!*************************************************!*\
  !*** ./js/pages/dashboard/dashboard.updater.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "DashUpdate": () => (/* binding */ DashUpdate)
/* harmony export */ });
/* harmony import */ var _utils_calc__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/calc */ "./js/utils/calc.js");
/* harmony import */ var _charts_charts_manager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../charts/charts.manager */ "./js/pages/charts/charts.manager.js");
/* harmony import */ var _charts_chart_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../charts/chart.utils */ "./js/pages/charts/chart.utils.js");
...
class DashUpdate {
  ...
  static updateTime(element, value) {
    this.updateHtml(element, _utils_calc__WEBPACK_IMPORTED_MODULE_0__.default.generateTime(value));
  }

  static updateProgress(element, value, rounding = 2) {
    this.updateHtml(element, _utils_calc__WEBPACK_IMPORTED_MODULE_0__.default.perc(value, rounding));
    document.getElementById(element).style.width = _utils_calc__WEBPACK_IMPORTED_MODULE_0__.default.perc(value);
  }

  static updateTemp(element, temp) {
    const fixedTemp = _utils_calc__WEBPACK_IMPORTED_MODULE_0__.default.toFixed(temp);
  ...
  static farmInformation(
    ...
    if (dashboardSettings.historical.hourlyTotalTemperatures) {
      _charts_charts_manager__WEBPACK_IMPORTED_MODULE_1__.ChartsManager.updateHourlyTotalTemperatureChart(temperatureGraph);
      this.updateTemp("totalTemp", totalFTemp);
    }
    if (dashboardSettings.historical.weeklyUtilisation) {
      _charts_charts_manager__WEBPACK_IMPORTED_MODULE_1__.ChartsManager.updateWeeklyUtilisationPerDayHeatMapChart(heatMap);
    }
  }
  ...
  static currentStatusAndUtilisation(
    ...
    if (settingsUtilisation) {
      _charts_charts_manager__WEBPACK_IMPORTED_MODULE_1__.ChartsManager.updateCurrentUtilisation(currentStatus);
    }

    if (settingsActivity) {
      _charts_charts_manager__WEBPACK_IMPORTED_MODULE_1__.ChartsManager.updateCurrentStatus(currentActivity);
    }
  }
  ...
  static async environmentalData(data) {
      ...
      for (let i = 0; i < data.length; i++) {
        if (data[i].data.length !== 0) {
          if (data[i].name === "Temperature") {
            analyzedLabels.push(_charts_chart_utils__WEBPACK_IMPORTED_MODULE_2__.temperatureLabel);
          }
          if (data[i].name === "Humidity") {
            analyzedLabels.push(_charts_chart_utils__WEBPACK_IMPORTED_MODULE_2__.humidityLabel);
          }
          if (data[i].name === "Pressure") {
            analyzedLabels.push(_charts_chart_utils__WEBPACK_IMPORTED_MODULE_2__.pressureLabel);
          }
          if (data[i].name === "IAQ") {
            analyzedLabels.push(_charts_chart_utils__WEBPACK_IMPORTED_MODULE_2__.iaqLabel);
          }
        }
      }
    ...
    if (analyzedLabels.length !== 0) {
      _charts_charts_manager__WEBPACK_IMPORTED_MODULE_1__.ChartsManager.updateEnvironmentDataChart(data);
      ...
      if (data[3].data.length > 0) {
        ...
        if (_utils_calc__WEBPACK_IMPORTED_MODULE_0__.default.isBetween(lastValue, 0, 50)) {
          state = "<i class=\"fas fa-check-circle textComplete\"></i> Excellent";
          impact = "Pure air; best for well-being";
          suggestedActions = "";
        }
        if (_utils_calc__WEBPACK_IMPORTED_MODULE_0__.default.isBetween(lastValue, 51, 100)) {
          state = "<i class=\"fas fa-check-circle\"></i> Good";
          impact = "No irritation or impact on well-being";
          suggestedActions = "";
        }
        if (_utils_calc__WEBPACK_IMPORTED_MODULE_0__.default.isBetween(lastValue, 101, 150)) {
        ...
        if (_utils_calc__WEBPACK_IMPORTED_MODULE_0__.default.isBetween(lastValue, 151, 200)) {
        ...
        if (_utils_calc__WEBPACK_IMPORTED_MODULE_0__.default.isBetween(lastValue, 201, 250)) {
        ...
        if (_utils_calc__WEBPACK_IMPORTED_MODULE_0__.default.isBetween(lastValue, 251, 350)) {
        ...
        if (_utils_calc__WEBPACK_IMPORTED_MODULE_0__.default.isBetween(lastValue, 350, 500)) {
...
/***/ "./js/pages/dashboard/grid-stack.manager.js":
/*!**************************************************!*\
  !*** ./js/pages/dashboard/grid-stack.manager.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "bindGraphChangeUpdate": () => (/* binding */ bindGraphChangeUpdate),
/* harmony export */   "saveGridStackConfigExplicitly": () => (/* binding */ saveGridStackConfigExplicitly)
/* harmony export */ });
/* harmony import */ var _dashboard_storage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dashboard.storage */ "./js/pages/dashboard/dashboard.storage.js");
...
/* harmony import */ var gridstack_dist_h5_gridstack_dd_native__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! gridstack/dist/h5/gridstack-dd-native */ "./node_modules/gridstack/dist/h5/gridstack-dd-native.js");
/* harmony import */ var gridstack_dist_h5_gridstack_dd_native__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(gridstack_dist_h5_gridstack_dd_native__WEBPACK_IMPORTED_MODULE_2__);
...
const gridStack = gridstack__WEBPACK_IMPORTED_MODULE_3__.GridStack.init({
  cellHeight: 50,
  float: true
});
...
async function loadGrid() {
  const dashConfig = _dashboard_storage__WEBPACK_IMPORTED_MODULE_0__.DashboardStorage.fetchConfig();

  if (dashConfig !== null && dashConfig.length !== 0) {
    const items = gridstack__WEBPACK_IMPORTED_MODULE_3__.GridStack.Utils.sort(dashConfig);
 ...
 * @param cb
 */
function bindGraphChangeUpdate(cb) {
  gridStack.on("change", async function (event, items) {
    _dashboard_storage__WEBPACK_IMPORTED_MODULE_0__.DashboardStorage.saveGridStackConfig(gridStack);
 ...
 */
function saveGridStackConfigExplicitly() {
  _dashboard_storage__WEBPACK_IMPORTED_MODULE_0__.DashboardStorage.saveGridStackConfig(gridStack);
}
...
"use strict";
/*!********************************!*\
  !*** ./js/dashboard.runner.js ***!
  \********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var gridstack_dist_gridstack_min_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! gridstack/dist/gridstack.min.css */ "./node_modules/gridstack/dist/gridstack.min.css");
/* harmony import */ var gridstack_dist_h5_gridstack_dd_native__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! gridstack/dist/h5/gridstack-dd-native */ "./node_modules/gridstack/dist/h5/gridstack-dd-native.js");
...
/* harmony import */ var _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./services/octofarm-client.service */ "./js/services/octofarm-client.service.js");
/* harmony import */ var _pages_dashboard_grid_stack_manager__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./pages/dashboard/grid-stack.manager */ "./js/pages/dashboard/grid-stack.manager.js");
/* harmony import */ var _pages_charts_charts_manager__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./pages/charts/charts.manager */ "./js/pages/charts/charts.manager.js");
/* harmony import */ var _services_client_worker_service_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./services/client-worker.service.js */ "./js/services/client-worker.service.js");
/* harmony import */ var _pages_charts_chart_utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./pages/charts/chart.utils */ "./js/pages/charts/chart.utils.js");
/* harmony import */ var _pages_dashboard_dashboard_sse_handler__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./pages/dashboard/dashboard-sse.handler */ "./js/pages/dashboard/dashboard-sse.handler.js");
...
async function updateHistoryGraphs() {
  let historyStatistics = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_2__.default.getHistoryStatistics();
  ...
  await _pages_charts_charts_manager__WEBPACK_IMPORTED_MODULE_4__.ChartsManager.updateFilamentOverTimeChartSeries(filamentUsageOverTime);
  await _pages_charts_charts_manager__WEBPACK_IMPORTED_MODULE_4__.ChartsManager.updateFilamentUsageByDayChartSeries(filamentUsageByDay);
  await _pages_charts_charts_manager__WEBPACK_IMPORTED_MODULE_4__.ChartsManager.updatePrintCompletionByDaySeries(historyGraphData);
}

async function initNewGraphs() {
  await _pages_charts_charts_manager__WEBPACK_IMPORTED_MODULE_4__.ChartsManager.renderDefaultCharts();
  ...
  filamentUsageOverTime.forEach((usage, index) => {
    ...
    if (index === 0) {
      obj = {
        ...
        labels: {
          formatter: _pages_charts_chart_utils__WEBPACK_IMPORTED_MODULE_6__.toFixedWeightGramFormatter
        }
      };
    } else {
      obj = {
  ...
  await _pages_charts_charts_manager__WEBPACK_IMPORTED_MODULE_4__.ChartsManager.renderFilamentUsageOverTimeChart(filamentUsageOverTime, yAxisSeries);

  const yAxis = [(0,_pages_charts_chart_utils__WEBPACK_IMPORTED_MODULE_6__.getUsageWeightSeries)("Weight", filamentUsageByDay[0]?.name)];
  await _pages_charts_charts_manager__WEBPACK_IMPORTED_MODULE_4__.ChartsManager.renderFilamentUsageByDayChart(filamentUsageByDay, yAxis);
  await _pages_charts_charts_manager__WEBPACK_IMPORTED_MODULE_4__.ChartsManager.renderPrintCompletionByDay(printCompletionByDay);
}

(0,_services_client_worker_service_js__WEBPACK_IMPORTED_MODULE_5__.createClientSSEWorker)(_pages_dashboard_dashboard_sse_handler__WEBPACK_IMPORTED_MODULE_7__.workerURL, _pages_dashboard_dashboard_sse_handler__WEBPACK_IMPORTED_MODULE_7__.dashboardSSEventHandler);

(0,_pages_dashboard_grid_stack_manager__WEBPACK_IMPORTED_MODULE_3__.loadGrid)()
  .then(async () => {
    await initNewGraphs();
  })
  .then(() => {
    (0,_pages_dashboard_grid_stack_manager__WEBPACK_IMPORTED_MODULE_3__.bindGraphChangeUpdate)(async function (event, items) {
