...
/***/ "./js/pages/system/client-settings.js":
/*!********************************************!*\
  !*** ./js/pages/system/client-settings.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ClientSettings)
/* harmony export */ });
...
class ClientSettings {
  static async init() {
    const clientSettings = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_0__.default.get("settings/client/get");
  ...
  static async update() {
    ...
    await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_0__.default.post("settings/client/update", opts);
    _utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.createAlert("success", "Client settings updated", 3000, "clicked");
...
/***/ "./js/pages/system/server.actions.js":
/*!*******************************************!*\
  !*** ./js/pages/system/server.actions.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "setupOPTimelapseSettings": () => (/* binding */ setupOPTimelapseSettings),
/* harmony export */   "generateLogDumpFile": () => (/* binding */ generateLogDumpFile),
/* harmony export */   "nukeDatabases": () => (/* binding */ nukeDatabases),
/* harmony export */   "exportDatabases": () => (/* binding */ exportDatabases),
/* harmony export */   "restartOctoFarmServer": () => (/* binding */ restartOctoFarmServer),
/* harmony export */   "checkFilamentManagerPluginState": () => (/* binding */ checkFilamentManagerPluginState),
/* harmony export */   "updateServerSettings": () => (/* binding */ updateServerSettings),
/* harmony export */   "updateOctoFarmCommand": () => (/* binding */ updateOctoFarmCommand),
/* harmony export */   "checkForOctoFarmUpdates": () => (/* binding */ checkForOctoFarmUpdates),
/* harmony export */   "grabOctoFarmLogList": () => (/* binding */ grabOctoFarmLogList),
/* harmony export */   "renderSystemCharts": () => (/* binding */ renderSystemCharts),
/* harmony export */   "startUpdateTasksRunner": () => (/* binding */ startUpdateTasksRunner),
/* harmony export */   "startUpdateInfoRunner": () => (/* binding */ startUpdateInfoRunner),
...
/* harmony export */   "fillInEditInformation": () => (/* binding */ fillInEditInformation),
/* harmony export */   "setupOPFilamentManagerPluginSettings": () => (/* binding */ setupOPFilamentManagerPluginSettings),
/* harmony export */   "clearOldLogs": () => (/* binding */ clearOldLogs)
/* harmony export */ });
/* harmony import */ var _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../services/octofarm-client.service */ "./js/services/octofarm-client.service.js");
/* harmony import */ var _utils_ui__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils/ui */ "./js/utils/ui.js");
/* harmony import */ var _utils_calc__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../utils/calc */ "./js/utils/calc.js");
/* harmony import */ var _utils_file__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../utils/file */ "./js/utils/file.js");
/* harmony import */ var _services_octoprint_octoprint_settings_actions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../services/octoprint/octoprint-settings.actions */ "./js/services/octoprint/octoprint-settings.actions.js");
/* harmony import */ var _services_filament_manager_plugin_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../services/filament-manager-plugin.service */ "./js/services/filament-manager-plugin.service.js");
/* harmony import */ var _server_options__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./server.options */ "./js/pages/system/server.options.js");
/* harmony import */ var _utils_bootbox_options__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./utils/bootbox.options */ "./js/pages/system/utils/bootbox.options.js");
/* harmony import */ var apexcharts__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! apexcharts */ "./node_modules/apexcharts/dist/apexcharts.common.js");
...
async function setupOPTimelapseSettings() {
  const printers = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_0__.default.listPrinters();
  const alert = _utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.createAlert(
    "warning",
    `${_utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.returnSpinnerTemplate()} Setting up your OctoPrint settings, please wait...`
  );
  const { successfulPrinters, failedPrinters } = await (0,_services_octoprint_octoprint_settings_actions__WEBPACK_IMPORTED_MODULE_4__.setupOctoPrintForTimelapses)(printers);
  alert.close();
...
async function setupOPFilamentManagerPluginSettings() {
  ...
  const settings = {
    uri: _server_options__WEBPACK_IMPORTED_MODULE_6__.filamentManagerPluginActionElements.postgresURI.value,
    name: _server_options__WEBPACK_IMPORTED_MODULE_6__.filamentManagerPluginActionElements.databaseName.value,
    user: _server_options__WEBPACK_IMPORTED_MODULE_6__.filamentManagerPluginActionElements.username.value,
    password: _server_options__WEBPACK_IMPORTED_MODULE_6__.filamentManagerPluginActionElements.password.value
  };

  if (!settings.uri.includes("postgresql://")) {
    _utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.createAlert("warning", "Your postgres URI isn't configured correctly!", 3000, "clicked");
    alert.close();
    return;
  }
  if (!settings.uri || !settings.name || !settings.user || !settings.password) {
    _utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.createAlert("warning", "You are missing some required fields!", 3000, "clicked");
    alert.close();
    return;
  }

  const { successfulPrinters, failedPrinters } = await (0,_services_octoprint_octoprint_settings_actions__WEBPACK_IMPORTED_MODULE_4__.setupOctoPrintForFilamentManager)(
    printers,
    settings
  );

  _server_options__WEBPACK_IMPORTED_MODULE_6__.filamentManagerPluginActionElements.postgresURI.value = "";
  _server_options__WEBPACK_IMPORTED_MODULE_6__.filamentManagerPluginActionElements.databaseName.value = "";
  _server_options__WEBPACK_IMPORTED_MODULE_6__.filamentManagerPluginActionElements.username.value = "";
  _server_options__WEBPACK_IMPORTED_MODULE_6__.filamentManagerPluginActionElements.password.value = "";
...
async function generateLogDumpFile() {
  let logDumpResponse = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_0__.default.generateLogDump();
  ...
  _utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.createAlert(logDumpResponse.status, logDumpResponse.msg, 5000, "clicked");
  ...
  if (logDumpDownloadBtn) {
    ...
    logDumpDownloadBtn.addEventListener("click", (e) => {
      ...
      window.open(
        `${_services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_0__.default.logsRoute}/${logDumpResponse.zipDumpPath}`
      );
    });
  }
}
...
async function nukeDatabases(database) {
  let databaseNuke;
  if (!database) {
    databaseNuke = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_0__.default.get("settings/server/delete/database");
  } else {
    databaseNuke = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_0__.default.get("settings/server/delete/database/" + database);
  }
  _utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.createAlert("success", databaseNuke.message, 3000);
}

async function exportDatabases(database) {
  const databaseExport = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_0__.default.get("settings/server/get/database/" + database);

  if (databaseExport?.databases[0].length !== 0) {
    _utils_file__WEBPACK_IMPORTED_MODULE_3__.default.download(database + ".json", JSON.stringify(databaseExport.databases));
  } else {
    _utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.createAlert("warning", "Database is empty, will not export...", 3000, "clicked");
  }
}
...
async function restartOctoFarmServer() {
  ...
  let restart = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_0__.default.restartServer();
  if (restart) {
    _utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.createAlert(
      "success",
...
async function checkFilamentManagerPluginState() {
  if (await (0,_services_filament_manager_plugin_service__WEBPACK_IMPORTED_MODULE_5__.isFilamentManagerPluginSyncEnabled)()) {
    (0,_services_filament_manager_plugin_service__WEBPACK_IMPORTED_MODULE_5__.setupFilamentManagerReSyncBtn)();
    (0,_services_filament_manager_plugin_service__WEBPACK_IMPORTED_MODULE_5__.setupFilamentManagerDisableBtn)();
  } else {
    (0,_services_filament_manager_plugin_service__WEBPACK_IMPORTED_MODULE_5__.setupFilamentManagerSyncBtn)();
  }
}
...
async function updateServerSettings() {
  const opts = {
    onlinePolling: {
      seconds: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.onlinePolling.seconds.value
    },
    server: {
      // Deprecated Port
      port: parseInt(_server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.server.port.value),
      loginRequired: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.server.loginRequired.checked,
      registration: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.server.registration.checked
    },
    timeout: {
      webSocketRetry: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.timeout.webSocketRetry.value * 1000,
      apiTimeout: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.timeout.apiTimeout.value * 1000,
      apiRetryCutoff: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.timeout.apiRetryCutoff.value * 1000,
      apiRetry: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.timeout.apiRetry.value * 1000
    },
    filament: {
      filamentCheck: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.filament.filamentCheck.checked,
      hideEmpty: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.filament.hideEmpty.checked,
      downDateFailed: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.filament.downDateFailed.checked,
      downDateSuccess: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.filament.downDateSuccess.checked
    },
    history: {
      snapshot: {
        onComplete: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.history.snapshot.onComplete.checked,
        onFailure: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.history.snapshot.onComplete.checked
      },
      thumbnails: {
        onComplete: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.history.thumbnails.onComplete.checked,
        onFailure: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.history.thumbnails.onComplete.checked
      },
      timelapse: {
        onComplete: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.history.timelapse.onComplete.checked,
        onFailure: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.history.timelapse.onComplete.checked,
        deleteAfter: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.history.timelapse.onComplete.checked
      }
    },
    influxExport: {
      active: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.influxExport.active.checked,
      host: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.influxExport.host.value,
      port: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.influxExport.port.value,
      database: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.influxExport.database.value,
      username: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.influxExport.username.value,
      password: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.influxExport.password.value,
      retentionPolicy: {
        duration: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.influxExport.retentionPolicy.duration.value,
        replication: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.influxExport.retentionPolicy.replication.value,
        defaultRet: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.influxExport.retentionPolicy.defaultRet.checked
      }
    },
    monitoringViews: {
      panel: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.monitoringViews.panel.checked,
      list: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.monitoringViews.list.checked,
      camera: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.monitoringViews.camera.checked,
      group: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.monitoringViews.group.checked,
      currentOperations: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.monitoringViews.currentOperations.checked,
      combined: _server_options__WEBPACK_IMPORTED_MODULE_6__.settingsElements.monitoringViews.combined.checked
    }
  };

  _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_0__.default.post("settings/server/update", opts).then((res) => {
    _utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.createAlert(`${res.status}`, `${res.msg}`, 3000, "Clicked");
    if (res.restartRequired) {
      bootbox.confirm(_utils_bootbox_options__WEBPACK_IMPORTED_MODULE_7__.serverBootBoxOptions.OF_SERVER_RESTART_REQUIRED);
    }
  });
}
...
async function updateOctoFarmCommand(doWeForcePull, doWeInstallPackages) {
  ...
  if (updateOctoFarmBtn) {
    ...
    _utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.addLoaderToElementsInnerHTML(updateOctoFarmBtn);
  }
  let updateData = {
    forcePull: false,
  ...
  let updateOctoFarm = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_0__.default.post("settings/server/update/octofarm", updateData);
  ...
  if (
    ...
    bootbox.confirm(
      _utils_bootbox_options__WEBPACK_IMPORTED_MODULE_7__.serverBootBoxOptions.OF_UPDATE_LOCAL_CHANGES(updateOctoFarmBtn, updateOctoFarm.message)
    );
    return;
  }
  // Local changes are detected, question whether we overwrite or cancel..
  ...
  _utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.removeLoaderFromElementInnerHTML(updateOctoFarmBtn);
...
async function checkForOctoFarmUpdates() {
  ...
  let updateCheck = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_0__.default.get("settings/server/update/octofarm");
  ...
  if (updateCheck?.update_available) {
    ...
    _utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.createAlert("warning", "Sorry there are no new updates available!", 5000, "Clicked");
  }
...
async function grabOctoFarmLogList() {
  let logList = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_0__.default.get(_services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_0__.default.logsRoute);
  ...
  logList.forEach((logs) => {
    logTable.insertAdjacentHTML(
      ...
      `
            <tr id="log-${logs.name}">
                ...
                <td>${_utils_calc__WEBPACK_IMPORTED_MODULE_2__.default.bytes(logs.size)}</td>
                <td>
                <button id="${
                  logs.name
    ...
    document.getElementById(logs.name+"-download").addEventListener("click",  (event) => {
      window.open(`${_services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_0__.default.logsRoute}/${logs.name}`);
    });
    document.getElementById(logs.name+"-delete").addEventListener("click", async (event) => {
      event.target.disabled = true;
      try{
        await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_0__.default.deleteLogFile(logs.name);
        const logLine = document.getElementById(`log-${logs.name}`)
        logLine.remove();
        _utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.createAlert("success", "Successfully deleted " + logs.name + "!", 3000, "clicked")
      }catch(e){
        event.target.disabled = false;
        _utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.createAlert("error", "Failed to delete " + logs.name + "!", 3000, "clicked")
      }
    });
  });
}
...
async function clearOldLogs(){
  try {
    const deletedLogs = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_0__.default.clearOldLogs();
    if(deletedLogs.length === 0){
      _utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.createAlert("warning", "No logs older than 1 day to delete!", 3000, "clicked")
    }else{
      let message = "";
      ...
      _utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.createAlert("success", "Successfully cleaned house! <br>" + message, 3000, "clicked")
    }

  }catch (e) {
    _utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.createAlert("error", "Failed to house keep logs! " + e, 3000, "clicked")
  }
}

async function renderSystemCharts() {
  historicUsageGraph = new (apexcharts__WEBPACK_IMPORTED_MODULE_8___default())(document.querySelector("#historicUsageGraph"), options);
  await historicUsageGraph.render();
  cpuUsageDonut = new (apexcharts__WEBPACK_IMPORTED_MODULE_8___default())(document.querySelector("#cpuUsageDonut"), cpuOptions);
  await cpuUsageDonut.render();
  memoryUsageDonut = new (apexcharts__WEBPACK_IMPORTED_MODULE_8___default())(document.querySelector("#memoryUsageDonut"), memoryOptions);
...
async function updateLiveSystemInformation() {
  ...
  const systemInformation = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_0__.default.get("system/info");
  ...
  if (systemInformation?.uptime && !!procUptimeElem) {
    procUptimeElem.innerHTML = _utils_calc__WEBPACK_IMPORTED_MODULE_2__.default.generateTime(systemInformation.uptime);
  }

  if (systemInformation?.osUptime && !!sysUptimeElem) {
    sysUptimeElem.innerHTML = _utils_calc__WEBPACK_IMPORTED_MODULE_2__.default.generateTime(systemInformation.osUptime);
  }
...
function startUpdateTasksRunner() {
  setInterval(async function updateStatus() {
    const taskManagerState = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_0__.default.get("system/tasks");

    for (let task in taskManagerState) {
      const theTask = taskManagerState[task];

      _utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.doesElementNeedUpdating(
      ...
      _utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.doesElementNeedUpdating(
        theTask.duration
          ? _utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.generateMilisecondsTime(theTask.duration)
...
async function createNewUser() {
  _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.userCreateMessage.innerHTML = "";
  const newUser = {
    name: _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.createName.value,
    username: _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.createUserName.value,
    group: _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.createGroup.value,
    password: _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.createPassword.value,
    password2: _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.createPassword2.value
  };
  const createNewUser = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_0__.default.createNewUser(newUser);

  if (createNewUser.errors.length > 0) {
    createNewUser.errors.forEach((error) => {
      _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.userCreateMessage.insertAdjacentHTML(
        "beforeend",
        `
    ...
    _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.userTableContent.insertAdjacentHTML(
      "beforeend",
      ` 
    ...
    _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.createName.value = "";
    _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.createUserName.value = "";
    _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.createGroup.value = "User";
    _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.createPassword.value = "";
    _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.createPassword2.value = "";
    ...
    document
      ...
      .addEventListener("click", (e) => {
        _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.resetPasswordFooter.innerHTML = `
        ${(0,_server_options__WEBPACK_IMPORTED_MODULE_6__.returnSaveBtn)()}
        `;
    ...
    document
      ...
      .addEventListener("click", async (e) => {
        _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.editUserFooter.innerHTML = `
        ${(0,_server_options__WEBPACK_IMPORTED_MODULE_6__.returnSaveBtn)()}
        `;
    ...
    _utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.createAlert("success", "Successfully created your user!", 3000, "clicked");
  }
}

async function fillInEditInformation(id) {
  let editInformation = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_0__.default.getUser(id);
  _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.editName.value = editInformation.name;
  _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.editUserName.value = editInformation.username;
  _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.editGroup.value = editInformation.group;
}

async function editUser(id) {
  _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.userEditMessage.innerHTML = "";
  const newUserInfo = {
    name: _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.editName.value,
    username: _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.editUserName.value,
    group: _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.editGroup.value
  };
  const editedUser = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_0__.default.editUser(id, newUserInfo);
  if (editedUser.errors.length > 0) {
    ...
    _utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.createAlert("success", "Successfully updated your user!", 3000, "clicked");
    _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.editName.value = "";
    _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.editUserName.value = "";
    _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.editGroup.value = "User";
...
function deleteUser(id) {
  bootbox.confirm({
    ...
    callback: async function (result) {
      if (result) {
        const deletedUser = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_0__.default.deleteUser(id);
        if (deletedUser.errors.length > 0) {
          deletedUser.errors.forEach((error) => {
            _utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.createAlert("error", error.msg, 3000, "clicked");
          });
        } else {
          document.getElementById(`userRow-${deletedUser.userDeleted._id}`).remove();
          _utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.createAlert("success", "Successfully deleted your user!", 3000, "clicked");
        }
      }
    }
  });
...
async function resetUserPassword(id) {
  _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.userResetMessage.innerHTML = "";
  const newPassword = {
    password: _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.resetPassword.value,
    password2: _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.resetPassword2.value
  };
  let resetPassword = await _services_octofarm_client_service__WEBPACK_IMPORTED_MODULE_0__.default.resetUserPassword(id, newPassword);
  if (resetPassword.errors.length > 0) {
    resetPassword.errors.forEach((error) => {
      _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.userResetMessage.insertAdjacentHTML(
        "beforeend",
        `
        <div class="alert alert-warning text-dark" role="alert">
          <i class="fas fa-exclamation-triangle"></i> ${error.msg}
    ...
    _utils_ui__WEBPACK_IMPORTED_MODULE_1__.default.createAlert("success", "Successfully reset your users password!", 3000, "clicked");
    _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.resetPassword.value = "";
    _server_options__WEBPACK_IMPORTED_MODULE_6__.userActionElements.resetPassword2.value = "";
...
/***/ "./js/pages/system/server.options.js":
/*!*******************************************!*\
  !*** ./js/pages/system/server.options.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "serverDatabaseKeys": () => (/* binding */ serverDatabaseKeys),
/* harmony export */   "serverActionsElements": () => (/* binding */ serverActionsElements),
/* harmony export */   "localStorageKeys": () => (/* binding */ localStorageKeys),
/* harmony export */   "settingsElements": () => (/* binding */ settingsElements),
/* harmony export */   "userActionElements": () => (/* binding */ userActionElements),
/* harmony export */   "returnSaveBtn": () => (/* binding */ returnSaveBtn),
/* harmony export */   "filamentManagerPluginActionElements": () => (/* binding */ filamentManagerPluginActionElements)
/* harmony export */ });
...
/***/ "./js/pages/system/utils/bootbox.options.js":
/*!**************************************************!*\
  !*** ./js/pages/system/utils/bootbox.options.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "serverBootBoxOptions": () => (/* binding */ serverBootBoxOptions)
/* harmony export */ });
/* harmony import */ var _server_actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../server.actions */ "./js/pages/system/server.actions.js");
...
const serverBootBoxOptions = {
  OP_TIMELAPSE_SETUP: {
    ...
    callback: async function (result) {
      if (result) {
        (0,_server_actions__WEBPACK_IMPORTED_MODULE_0__.setupOPTimelapseSettings)();
      }
    }
  },
  OF_SERVER_RESTART_REQUIRED: {
    ...
    async callback(result) {
      if (result) {
        await (0,_server_actions__WEBPACK_IMPORTED_MODULE_0__.restartOctoFarmServer)();
      }
    }
  },
  OF_UPDATE_LOCAL_CHANGES: (updateOctoFarmBtn, message) => {
    return {
      ...
      async callback(result) {
        if (result) {
          await (0,_server_actions__WEBPACK_IMPORTED_MODULE_0__.updateOctoFarmCommand)(true);
        } else {
          if (updateOctoFarmBtn) {
  ...
  OF_UPDATE_MISSING_DEPENDENCIES: (updateOctoFarmBtn, message) => {
    return {
      ...
      callback: function (result) {
        if (result) {
          (0,_server_actions__WEBPACK_IMPORTED_MODULE_0__.updateOctoFarmCommand)(false, true);
        } else {
          if (updateOctoFarmBtn) {
            updateOctoFarmBtn.innerHTML = '<i class="fas fa-thumbs-up"></i> Update OctoFarm';
            updateOctoFarmBtn.disabled = false;
...
/* harmony export */ });
/* harmony import */ var _exceptions_application_error_handler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../exceptions/application-error.handler */ "./js/exceptions/application-error.handler.js");
/* harmony import */ var _exceptions_octofarm_client_exceptions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../exceptions/octofarm-client.exceptions */ "./js/exceptions/octofarm-client.exceptions.js");



function removeLocalStorage(key) {
  if (!key) throw new _exceptions_application_error_handler__WEBPACK_IMPORTED_MODULE_0__.ApplicationError(_exceptions_octofarm_client_exceptions__WEBPACK_IMPORTED_MODULE_1__.ClientErrors.FAILED_VALIDATION_KEY);
...
axios__WEBPACK_IMPORTED_MODULE_0___default().interceptors.response.use(
  ...
  function (error) {
    ...
    switch (error?.response?.status) {
      ...
      case 400:
        throw new _exceptions_application_error_handler__WEBPACK_IMPORTED_MODULE_1__.ApplicationError(_exceptions_octofarm_api_exceptions__WEBPACK_IMPORTED_MODULE_2__.HTTPError.BAD_REQUEST);
      case 401:
      ...
      case 500:
        throw new _exceptions_application_error_handler__WEBPACK_IMPORTED_MODULE_1__.ApplicationError(_exceptions_octofarm_api_exceptions__WEBPACK_IMPORTED_MODULE_2__.HTTPError.INTERNAL_SERVER_ERROR);
      case 502:
      ...
      case 503:
        throw new _exceptions_application_error_handler__WEBPACK_IMPORTED_MODULE_1__.ApplicationError(_exceptions_octofarm_api_exceptions__WEBPACK_IMPORTED_MODULE_2__.HTTPError.SERVICE_UNAVAILABLE);
      case 504:
      ...
      default:
        throw new _exceptions_application_error_handler__WEBPACK_IMPORTED_MODULE_1__.ApplicationError(_exceptions_octofarm_api_exceptions__WEBPACK_IMPORTED_MODULE_2__.HTTPError.UNKNOWN);
    }
  }
);
...
/***/ "./js/services/octofarm-scripts.service.js":
/*!*************************************************!*\
  !*** ./js/services/octofarm-scripts.service.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class Script {
  ...
  static async get() {
    let post = await _octofarm_client_service__WEBPACK_IMPORTED_MODULE_1__.default.get("scripts/get");
  ...
  static async saveEdit(id, newAlert) {
    ...
    let post = await _octofarm_client_service__WEBPACK_IMPORTED_MODULE_1__.default.post("scripts/edit", opts);
    if (!post) {
      _utils_ui_js__WEBPACK_IMPORTED_MODULE_0__.default.createAlert("error", "Failed to save your alert!", 3000, "Clicked");
    } else {
      _utils_ui_js__WEBPACK_IMPORTED_MODULE_0__.default.createAlert("success", "Successfully saved your alert!", 3000, "Clicked");
      Script.get();
    }
    let row = document.getElementById("alertList-" + id);
    let editable = row.querySelectorAll("[contenteditable]");
  ...
  static async save(newAlert) {
    ...
    let post = await _octofarm_client_service__WEBPACK_IMPORTED_MODULE_1__.default.post("scripts/save", opts);
    if (!post) {
      _utils_ui_js__WEBPACK_IMPORTED_MODULE_0__.default.createAlert("error", "Failed to save your alert!", 3000, "Clicked");
    } else {
      _utils_ui_js__WEBPACK_IMPORTED_MODULE_0__.default.createAlert("success", "Successfully saved your alert!", 3000, "Clicked");
  ...
  static async delete(id) {
    let post = await _octofarm_client_service__WEBPACK_IMPORTED_MODULE_1__.default.delete("scripts/delete/" + id);
    if (!post) {
      _utils_ui_js__WEBPACK_IMPORTED_MODULE_0__.default.createAlert("error", "Failed to delete your alert.", 3000, "Clicked");
    } else {
      _utils_ui_js__WEBPACK_IMPORTED_MODULE_0__.default.createAlert("success", "Successfully deleted your alert.", 3000, "Clicked");
  ...
  static async test(scriptLocation, message) {
    ...
    let post = await _octofarm_client_service__WEBPACK_IMPORTED_MODULE_1__.default.post("scripts/test", opts);
    if (typeof post.testFire === "object") {
      _utils_ui_js__WEBPACK_IMPORTED_MODULE_0__.default.createAlert("error", post.testFire.stderr, 3000, "Clicked");
    } else {
      _utils_ui_js__WEBPACK_IMPORTED_MODULE_0__.default.createAlert("success", post.testFire, 3000, "Clicked");
    }
  }
...
/***/ "./js/services/octoprint/octoprint-settings.actions.js":
/*!*************************************************************!*\
  !*** ./js/services/octoprint/octoprint-settings.actions.js ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "setupOctoPrintForTimelapses": () => (/* binding */ setupOctoPrintForTimelapses),
/* harmony export */   "setupOctoPrintForFilamentManager": () => (/* binding */ setupOctoPrintForFilamentManager),
/* harmony export */   "setupOctoPrintForVirtualPrinter": () => (/* binding */ setupOctoPrintForVirtualPrinter)
/* harmony export */ });
...
async function setupOctoPrintForTimelapses(printers) {
  ...
  for (let i = 0; i < printers.length; i++) {
    if (printers[i].printerState.colour.category !== "Offline") {
      await _octoprint_client_service__WEBPACK_IMPORTED_MODULE_0__.default.post(printers[i], "settings", webCamSettings);
      await _octoprint_client_service__WEBPACK_IMPORTED_MODULE_0__.default.post(printers[i], "timelapse", timeLapseSettings);
      await _octofarm_client_service__WEBPACK_IMPORTED_MODULE_1__.default.refreshPrinterSettings(printers[i]._id);
...
async function setupOctoPrintForFilamentManager(printers, settings) {
  ...
  for (let i = 0; i < printers.length; i++) {
    if (printers[i].printerState.colour.category !== "Offline") {
      await _octoprint_client_service__WEBPACK_IMPORTED_MODULE_0__.default.post(printers[i], "settings", filamentManagerSettings);
      await _octofarm_client_service__WEBPACK_IMPORTED_MODULE_1__.default.refreshPrinterSettings(printers[i]._id);
      successfulPrinters += `<i class="fas fa-check-circle text-success"></i> ${printers[i].printerName}: Settings Updated! <br>`;
    } else {
      failedPrinters += `<i class="fas fa-check-circle text-danger"></i> ${printers[i].printerName}: Offline! <br>`;
...
async function setupOctoPrintForVirtualPrinter(printers) {
  ...
  for (let i = 0; i < printers.length; i++) {
    if (printers[i].printerState.colour.category !== "Offline") {
      await _octoprint_client_service__WEBPACK_IMPORTED_MODULE_0__.default.post(printers[i], "settings", virtualPrinterSettings);
      await _octofarm_client_service__WEBPACK_IMPORTED_MODULE_1__.default.refreshPrinterSettings(printers[i]._id);
      successfulPrinters += `<i class="fas fa-check-circle text-success"></i> ${printers[i].printerName}: Settings Updated! <br>`;
    } else {
      failedPrinters += `<i class="fas fa-check-circle text-danger"></i> ${printers[i].printerName}: Offline! <br>`;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ FileOperations)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utils_ui_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/ui.js */ "./js/utils/ui.js");
/* harmony import */ var _services_octofarm_scripts_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./services/octofarm-scripts.service */ "./js/services/octofarm-scripts.service.js");
/* harmony import */ var _pages_system_client_settings__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pages/system/client-settings */ "./js/pages/system/client-settings.js");
/* harmony import */ var _pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./pages/system/server.options */ "./js/pages/system/server.options.js");
/* harmony import */ var _pages_system_server_actions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./pages/system/server.actions */ "./js/pages/system/server.actions.js");
/* harmony import */ var _pages_system_utils_bootbox_options__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./pages/system/utils/bootbox.options */ "./js/pages/system/utils/bootbox.options.js");
/* harmony import */ var _services_local_storage_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./services/local-storage.service */ "./js/services/local-storage.service.js");
...
// Setup Page
for (const key in _pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverDatabaseKeys) {
  if (_pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverDatabaseKeys.hasOwnProperty(key)) {
    const element = document.getElementById(`nuke${_pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverDatabaseKeys[key]}`);
    if (element) {
      element.addEventListener("click", async (e) => {
        const alert = _utils_ui_js__WEBPACK_IMPORTED_MODULE_0__.default.createAlert(
          "warning",
          `${_utils_ui_js__WEBPACK_IMPORTED_MODULE_0__.default.returnSpinnerTemplate()} Deleting ${_pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverDatabaseKeys[key]} database...`
        );
        await (0,_pages_system_server_actions__WEBPACK_IMPORTED_MODULE_4__.nukeDatabases)(`${_pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverDatabaseKeys[key]}DB`, e);
        alert.close();
      });
    }

    if (key !== "ALL") {
      const element = document.getElementById(`export${_pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverDatabaseKeys[key]}`);

      if (element) {
        element.addEventListener("click", async (e) => {
          const alert = _utils_ui_js__WEBPACK_IMPORTED_MODULE_0__.default.createAlert(
            "warning",
            `${_utils_ui_js__WEBPACK_IMPORTED_MODULE_0__.default.returnSpinnerTemplate()} Preparing ${_pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverDatabaseKeys[key]} database...`
          );
          await (0,_pages_system_server_actions__WEBPACK_IMPORTED_MODULE_4__.exportDatabases)(`${_pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverDatabaseKeys[key]}DB`, e);
          alert.close();
        });
      }
    }
...
if (_pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverActionsElements.LOG_DUMP_GENERATE) {
  (0,_pages_system_server_actions__WEBPACK_IMPORTED_MODULE_4__.checkFilamentManagerPluginState)().then();
  (0,_pages_system_server_actions__WEBPACK_IMPORTED_MODULE_4__.grabOctoFarmLogList)().then();
  _services_octofarm_scripts_service__WEBPACK_IMPORTED_MODULE_1__.default.get().then();
}

(0,_pages_system_server_actions__WEBPACK_IMPORTED_MODULE_4__.renderSystemCharts)().then();
(0,_pages_system_server_actions__WEBPACK_IMPORTED_MODULE_4__.startUpdateTasksRunner)();
(0,_pages_system_server_actions__WEBPACK_IMPORTED_MODULE_4__.startUpdateInfoRunner)().then();
_pages_system_client_settings__WEBPACK_IMPORTED_MODULE_2__.default.init().then();

if(_pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverActionsElements.CLEAR_OLD_LOGS){
  _pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverActionsElements.CLEAR_OLD_LOGS.addEventListener("click", async (e) => {
    await (0,_pages_system_server_actions__WEBPACK_IMPORTED_MODULE_4__.clearOldLogs)();
  })
}

if (_pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverActionsElements.OP_TIMELAPSE_SETUP) {
  _pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverActionsElements.OP_TIMELAPSE_SETUP.addEventListener("click", async (e) => {
    bootbox.confirm(_pages_system_utils_bootbox_options__WEBPACK_IMPORTED_MODULE_5__.serverBootBoxOptions.OP_TIMELAPSE_SETUP);
  });
}

if (_pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverActionsElements.OP_FILAMENT_SETUP) {
  _pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverActionsElements.OP_FILAMENT_SETUP.addEventListener("click", async (e) => {
    await (0,_pages_system_server_actions__WEBPACK_IMPORTED_MODULE_4__.setupOPFilamentManagerPluginSettings)();
  });
}

if (_pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverActionsElements.LOG_DUMP_GENERATE) {
  _pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverActionsElements.LOG_DUMP_GENERATE.addEventListener("click", async (e) => {
    const alert = _utils_ui_js__WEBPACK_IMPORTED_MODULE_0__.default.createAlert(
      "warning",
      `${_utils_ui_js__WEBPACK_IMPORTED_MODULE_0__.default.returnSpinnerTemplate()} Generating log dump, please wait...`
    );
    await (0,_pages_system_server_actions__WEBPACK_IMPORTED_MODULE_4__.generateLogDumpFile)();
    alert.close();
  });
}

if (_pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverActionsElements.RESET_DASHBOARD) {
  _pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverActionsElements.RESET_DASHBOARD.addEventListener("click", (e) => {
    (0,_services_local_storage_service__WEBPACK_IMPORTED_MODULE_6__.removeLocalStorage)(_pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.localStorageKeys.DASHBOARD_SETTINGS);
    _utils_ui_js__WEBPACK_IMPORTED_MODULE_0__.default.createAlert("success", "Dashboard data cleared from browser", 3000, "clicked");
  });
}

if (_pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverActionsElements.SAVE_SERVER_SETTINGS) {
  _pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverActionsElements.SAVE_SERVER_SETTINGS.addEventListener("click", async (e) => {
    // Validate Printer Form, then Add
    await (0,_pages_system_server_actions__WEBPACK_IMPORTED_MODULE_4__.updateServerSettings)();
  });
}

if (_pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverActionsElements.RESTART_OCTOFARM) {
  _pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverActionsElements.RESTART_OCTOFARM.addEventListener("click", async (e) => {
    await (0,_pages_system_server_actions__WEBPACK_IMPORTED_MODULE_4__.restartOctoFarmServer)();
  });
}

if (_pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverActionsElements.UPDATE_OCTOFARM) {
  _pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverActionsElements.UPDATE_OCTOFARM.addEventListener("click", async (e) => {
    await (0,_pages_system_server_actions__WEBPACK_IMPORTED_MODULE_4__.updateOctoFarmCommand)(false);
  });
}

if (_pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverActionsElements.CHECK_OCTOFARM_UPDATES) {
  _pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverActionsElements.CHECK_OCTOFARM_UPDATES.addEventListener("click", async (e) => {
    await (0,_pages_system_server_actions__WEBPACK_IMPORTED_MODULE_4__.checkForOctoFarmUpdates)();
  });
}

if (_pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverActionsElements.SAVE_CLIENT_SETTINGS) {
  _pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.serverActionsElements.SAVE_CLIENT_SETTINGS.addEventListener("click", async (e) => {
    // Validate Printer Form, then Add
    await _pages_system_client_settings__WEBPACK_IMPORTED_MODULE_2__.default.update();
  });
}

if (_pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.userActionElements.createUserBtn) {
  // Setup user create btn
  _pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.userActionElements.createUserBtn.addEventListener("click", (e) => {
    _pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.userActionElements.createUserFooter.innerHTML = `
    ${(0,_pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.returnSaveBtn)()}
  `;
    const userActionSave = document.getElementById("userActionSave");
    userActionSave.addEventListener("click", async () => {
      await (0,_pages_system_server_actions__WEBPACK_IMPORTED_MODULE_4__.createNewUser)();
    });
  });
}
...
passResetButtons.forEach((btn) => {
  ...
  btn.addEventListener("click", (e) => {
    _pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.userActionElements.resetPasswordFooter.innerHTML = `
    ${(0,_pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.returnSaveBtn)()}
  `;
    const userActionSave = document.getElementById("userActionSave");
    userActionSave.addEventListener("click", async () => {
      await (0,_pages_system_server_actions__WEBPACK_IMPORTED_MODULE_4__.resetUserPassword)(split[1]);
    });
  });
});
...
userEditButtons.forEach((btn) => {
  ...
  btn.addEventListener("click", async (e) => {
    _pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.userActionElements.editUserFooter.innerHTML = `
    ${(0,_pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.returnSaveBtn)()}
  `;
    await (0,_pages_system_server_actions__WEBPACK_IMPORTED_MODULE_4__.fillInEditInformation)(split[1]);
    const userActionSave = document.getElementById("userActionSave");
    userActionSave.addEventListener("click", async () => {
      await (0,_pages_system_server_actions__WEBPACK_IMPORTED_MODULE_4__.editUser)(split[1]);
    });
  });
});
...
deleteButtons.forEach((btn) => {
  const split = btn.id.split("-");
  btn.addEventListener("click", (e) => {
    (0,_pages_system_server_actions__WEBPACK_IMPORTED_MODULE_4__.deleteUser)(split[1]);
  });
});

$("#userCreateModal").on("hidden.bs.modal", function (e) {
  const userActionSave = document.getElementById("userActionSave");
  _pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.userActionElements.userCreateMessage.innerHTML = "";
  userActionSave.remove();
});
$("#usersResetPasswordModal").on("hidden.bs.modal", function (e) {
  const userActionSave = document.getElementById("userActionSave");
  _pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.userActionElements.userResetMessage.innerHTML = "";
  userActionSave.remove();
});
$("#userEditModal").on("hidden.bs.modal", function (e) {
  const userActionSave = document.getElementById("userActionSave");
  _pages_system_server_options__WEBPACK_IMPORTED_MODULE_3__.userActionElements.userEditMessage.innerHTML = "";
  userActionSave.remove();
});
