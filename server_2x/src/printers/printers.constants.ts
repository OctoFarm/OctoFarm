 ...
 */
export function getDefaultFileCleanStatistics() {
  return {
    storageUsed: 0,
    storageTotal: 0,
    storageRemain: 0,
 ...
 */
export function getDefaultDashboardStatisticsObject() {
  return {
    currentUtilisation: {},
    currentStatus: {},
    timeEstimates: {},
...
export const DEFAULT_SPOOL_DENSITY = 1.24;
export const DEFAULT_SPOOL_RATIO = 1.75 / 2;
 ...
 */
export function getEmptyHeatmap() {
  return [
    {
      name: "Completed",
      data: []
 ...
 * @returns {({data: [], name: string}|{data: [], name: string}|{data: [], name: string}|{data: [], name: string}|{data: [], name: string})[]}
 */
export function getEmptyToolTemperatureArray() {
  return [
    {
      name: "Actual Tool",
      data: []
...
export function getEmptyOperationsObject() {
  return {
    operations: [],
    count: {
      printerCount: 0,
