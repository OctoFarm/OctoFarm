    ...
    return `
        <tr id="queueRow-${file.index}">
            ...
            <td class="align-middle">
                <div class="progress">
                    <div id="queueProgressBar-${file.index}" class="progress-bar progress-bar-striped bg-info"
...
export const getFileRowID = (record) => {
    return `${record.name.replace(/[^a-zA-Z0-9 ]/g, "")}-${record.printer.replace(/[^a-zA-Z0-9 ]/g, "")}`
}