export function createPrinterAddInstructions() {
  return `<div class="row">
        <div class="col-lg-12">
            ...
            <p>OctoPrint will require settings changes and a service restart before
            ...
            <div class="row pb-1">
                ...
                <div class="col">
                    ...
                    <input id="psPrinterURL" type="text" class="form-control" placeholder="Printer URL" disabled>
                        <small class="form-text text-muted">URL of OctoPrint host with port. Defaults to "http://"
            ...
            <div class="row pb-2">
                <div class="col">
                    ...
                    <input id="psPrinterGroup" type="text" class="form-control" placeholder="Printer Group"
                           disabled>
                        <small class="form-text text-muted">OctoFarm allows for grouping related printers</small>
                        <small>Example: <code>http://192.168.1.5:81</code></small>
                </div>
                <div class="col">
                    <label htmlFor="psAPIKEY">API Key:</label>
                    <input id="psAPIKEY" type="text" class="form-control" placeholder="API Key" disabled>
                        <small class="form-text text-muted">OctoPrint API Key. It's required to use the
                            User/Application API Key for OctoPrint versions 1.4.1+.</small>
    ...
    <div class="collapse" id="octoprintCollapse">
        <div class="card card-body">
            ...
            <div class="row">
                <div class="col-md-9">
                    <p>2. Grab your OctoPrint instance's API Key.<br> This can be generated in the User Settings dialog.
                    </p>
            ...
            <div class="row">
                <div class="col-md-5">
                    <p>2.1 You can generate an API Key from your current user.</p>
                    <code>Please note, this OctoPrint user requires Admin rights. If in doubt, it's usually
        ...
        <div class="row">
            <div class="col-md-5">
                <p>2.1 You can generate an API Key for a specific application.</p>
                <code>Please note, this OctoPrint user requires Admin rights. If in doubt, it's usually the
