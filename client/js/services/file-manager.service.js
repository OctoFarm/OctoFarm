...
import {getFolderTemplate} from "../pages/file-manager/file.template";
import {generatePathList} from "../pages/file-manager/file-manager.helpers";
        ...
        if (result) {
          ...
          if (post.status === 404) {
            ...
            try{
              ...
              UI.createAlert("danger", `Unable to move your file! Error ${e}`, 0, "Clicked")
            }
