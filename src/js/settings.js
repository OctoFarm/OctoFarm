...
if (serializedData !== null && serializedData.length !== 0) {
  serializedData.forEach((data) => {
    document.getElementById("currentDashboardLocationData").insertAdjacentHTML(
      "beforeend",
      `
